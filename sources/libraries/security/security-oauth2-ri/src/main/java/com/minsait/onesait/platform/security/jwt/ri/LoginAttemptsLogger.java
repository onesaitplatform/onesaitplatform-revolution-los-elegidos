...
public class LoginAttemptsLogger {
    ...
    public void auditEventHappened(AuditApplicationEvent auditApplicationEvent) {
        ...
        log.info("Begin -> Audit Login Happened -> Principal {} - {}" + auditEvent.getPrincipal(),
                 auditEvent.getType());
        ...
        if (auditEvent.getData().get(DETAILS_STR) instanceof WebAuthenticationDetails) {
            ...
            log.info("  Class Id: WebAuthenticationDetails Remote IP address: {}, Session Id: {}",
            ...
            log.info(
                    "  Class Id: OAuth2AuthenticationDetails Remote IP address: {}, Session Id: {}, Token Type: {}, " +
                            "Token Value: {}",
