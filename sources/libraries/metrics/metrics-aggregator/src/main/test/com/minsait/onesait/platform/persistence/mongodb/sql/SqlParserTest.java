...
public class SqlParserTest {
    ...
    public void UpdateSqlGetsTranslated() throws JSQLParserException {
        final String update = "UPDATE HelsinkiPopulation SET Helsinki.year=2018, Helsinki.population=10000 WHERE " +
                "Helsinki.year > 1875 AND Helsinki.year != 2000 ";
        ...
        assertEquals(mongoDbQuery.toString(),
                     "db.HelsinkiPopulation.update({$and:[{'Helsinki.year':{$gt:1875}},{'Helsinki" +
                             ".year':{$ne:2000}}]},{'Helsinki.year':2018,'Helsinki.population':10000})");
    ...
    public void UpdateSelectOR() {
        final String update = "UPDATE DemoDate SET DemoDate.id='#5' WHERE _id=\"5c6694fe032037138a4b7615\" OR " +
                "_id=\"5c6694fe032037138a4b7615\"";
        final String translatedQuery = Sql2NativeTool.translateSql(update);
    ...
    public void UpdateSelectORAND() {
        final String update = "UPDATE DemoDate SET DemoDate.id='#5' WHERE (_id=\"5c6694fe032037138a4b7615\" OR " +
                "_id=\"5c6694fe032037138a4b7615\") AND DemoDate.id='#5' ";
        final String translatedQuery = Sql2NativeTool.translateSql(update);
