...
public class MongoDbToolsAdapterImpl extends MongoDbToolsAdapter {
    ...
    @Override
    public String runMongoExportCommand(String database, String collection, String query,
        ...
        log.info(
                "The mongoexport command has been executed. Database = {}, collection = {}, query = {}, outputFile = " +
                        "{}, output = {}.",
    ...
    @Override
    public String runMongoImportCommand(String database, String collection,
            String inputFile) throws CommandExecutionException {
    ...
    public String runMongoImportCommand(String database, String collection, String inputFile,
            String accion) throws CommandExecutionException {
