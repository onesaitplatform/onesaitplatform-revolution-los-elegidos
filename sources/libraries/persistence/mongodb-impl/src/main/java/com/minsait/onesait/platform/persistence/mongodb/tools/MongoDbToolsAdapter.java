...
public abstract class MongoDbToolsAdapter {
     ...
     * @throws CommandExecutionException
     */
    public abstract String runMongoExportCommand(String database, String collection, String query,
     ...
     * @throws CommandExecutionException
     */
    public abstract String runMongoImportCommand(String database, String collection,
