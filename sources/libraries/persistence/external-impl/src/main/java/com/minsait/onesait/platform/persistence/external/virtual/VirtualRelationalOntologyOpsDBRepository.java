...
public class VirtualRelationalOntologyOpsDBRepository implements VirtualOntologyDBRepository {
    ...
    private OntologyVirtualDatasource getDatasourceForOntology(String ontology) {
        try {
            ...
            OntologyVirtualDatasource ontologyDatasource =
                    this.ontologyVirtualRepository.findOntologyVirtualDatasourceByOntologyIdentification(
                    ontology);
    ...
    private JdbcTemplate getJdbTemplate(String ontology) {
        try {
            ...
            VirtualDataSourceDescriptor datasource = this.virtualDatasourcesManager.getDataSourceDescriptor(
                    datasourceName);
    ...
    public String insert(String ontology, String schema, String instance) {
        try {
            ...
            String objectId = this.ontologyVirtualRepository.findOntologyVirtualObjectIdByOntologyIdentification(
                    ontology);
    ...
    public MultiDocumentOperationResult updateNativeByObjectIdAndBodyData(String ontologyName, String objectId,
        ...
        try {
            ...
            return this.updateNative(ontologyName,
                                     "UPDATE " + ontologyName + " SET " + body + WHERE_STR + objId + " = " + objectId,
                                     false);
        } catch (DBPersistenceException e) {
            throw e;
        } catch (Exception e) {
    ...
    public List<String> getInstanceFromTable(String datasource, String query) {
        try {
            ...
            VirtualDataSourceDescriptor sourceDescriptor = this.virtualDatasourcesManager.getDataSourceDescriptor(
                    datasource);
