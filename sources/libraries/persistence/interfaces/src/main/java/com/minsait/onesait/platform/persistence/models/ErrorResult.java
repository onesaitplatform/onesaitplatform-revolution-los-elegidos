...
public class ErrorResult {
    ...
    public enum ErrorType {
        ERROR("General error"), DUPLICATED("Duplicated key"), SYNTAX("Syntax error");
    ...
    public enum PersistenceType {
        PERSISTENCE("Persistence"), VIRTUAL("Virtual"), MYSQL("MySQL"), MONGO("MongoDB"), ORACLE("Oracle"),
        SQLSERVER("SQLServer"), ELASTIC("Elasticsearch"), KUDU("Kudu"), IMPALA("Impala"), API("Impala"), HIVE("Hive");
