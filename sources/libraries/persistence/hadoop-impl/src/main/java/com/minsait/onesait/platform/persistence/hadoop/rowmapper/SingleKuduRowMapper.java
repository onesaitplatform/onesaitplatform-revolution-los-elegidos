 ...
 */
package com.minsait.onesait.platform.persistence.hadoop.rowmapper;
...
@Slf4j
public class SingleKuduRowMapper implements RowMapper<String> {
            ...
            try {
                ...
                if (isContexDataField(columnName)) {
                    ...
                    try {
                        ...
                        obj.put(getGeometryColumnName(columnName), new JSONObject(mapper.writeValueAsString(geometry)));
