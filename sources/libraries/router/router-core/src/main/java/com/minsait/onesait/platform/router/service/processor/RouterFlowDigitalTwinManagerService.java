...
public class RouterFlowDigitalTwinManagerService {
    ...
    private void dispathEvent(DigitalTwinCompositeModel compositeModel, String event) {
        try {
            if (event.equalsIgnoreCase(DigitalTwinModel.EventType.PING.name()) || event.equalsIgnoreCase(
                    DigitalTwinModel.EventType.REGISTER.name()) || event.equalsIgnoreCase(
                    DigitalTwinModel.EventType.RULE.name()) || event.equalsIgnoreCase(
                    DigitalTwinModel.EventType.FLOW.name()) || event.equalsIgnoreCase(
                    DigitalTwinModel.EventType.NOTEBOOK.name()) || event.equalsIgnoreCase(
                    DigitalTwinModel.EventType.CUSTOM.name())) {
