    ...
    public void audit(String item) throws JSONException, RouterCrudServiceException {
        ...
        try {
            ...
            if (commonParams.getUser() != null) {
                ...
                final OperationModel model = OperationModel.builder(ontology, OperationType.INSERT,
                                                                    commonParams.getUser(), operation).body(
                        item).queryType(
                        com.minsait.onesait.platform.router.service.app.model.OperationModel.QueryType.NONE).cacheable(
                        false).build();
