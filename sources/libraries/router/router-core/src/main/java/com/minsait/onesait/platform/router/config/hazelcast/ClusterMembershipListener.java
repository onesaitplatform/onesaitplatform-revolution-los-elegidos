...
public class ClusterMembershipListener implements MembershipListener {
    ...
    public void memberAdded(MembershipEvent membershipEvent) {
        ...
        log.info(
                "Info Added HOST: " + membershipEvent.getMember().getAddress().getHost() + ":" + membershipEvent.getMember().getAddress().getPort());
    ...
    public void memberRemoved(MembershipEvent membershipEvent) {
        ...
        log.info(
                "Info Removed HOST: " + membershipEvent.getMember().getAddress().getHost() + ":" + membershipEvent.getMember().getAddress().getPort());
