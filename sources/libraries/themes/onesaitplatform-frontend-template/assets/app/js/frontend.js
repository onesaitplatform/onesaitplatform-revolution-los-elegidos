var FrontendController = function () {
    ...
    var handleConfiguration = function (configuration) {
        ...
        if (!configuration) {
            $.alert({title: 'Configuration ERROR!', content: 'No Configuration Data!'});
            return false;
        }
    ...
    var changeTheme = function (currentSkin, newSkin) {
        ...
        // no skin, no fun!
        if (!newSkin) {
            $.alert({title: 'Configuration ERROR!', content: 'No Skin or not valid for Change Theme!'});
            return;
        }
    ...
    var changeMenu = function (currentSkin, newSkin) {
        ...
        // no skin, no fun!
        if (!newSkin) {
            $.alert({title: 'Configuration ERROR!', content: 'No Skin or not valid for Change Menu Theme!'});
            return;
        }
