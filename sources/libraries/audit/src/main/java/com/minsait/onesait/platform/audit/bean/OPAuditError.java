...
public class OPAuditError extends OPAuditRemoteEvent {
    ...
    public String toString() {
        ...
        return "OPAuditError [message=" + message + ", id=" + id + ", type=" + type + ", timeStamp=" + timeStamp + "," +
                " user=" + user + ", ontology=" + ontology + ", operationType=" + operationType + ", module=" + module + ", errorMessage=" + errorMessage + ", extraData=" + extraData + ", otherType=" + otherType + ", className=" + className + ", methodName=" + methodName + "]";
    }
