...
/**
 * A holder of selected HTTP details related to an OAuth2 authentication
 * request.
 *
...
public class OAuth2AuthenticationDetails implements Serializable {
    ...
    public static final String ACCESS_TOKEN_VALUE = OAuth2AuthenticationDetails.class.getSimpleName() +
            ".ACCESS_TOKEN_VALUE";

    public static final String ACCESS_TOKEN_TYPE = OAuth2AuthenticationDetails.class.getSimpleName() +
            ".ACCESS_TOKEN_TYPE";
    ...
    /**
     * Records the access token value and remote address and will also set the
     * session Id if a session already exists (it won't create one).
     *
     * @param request
    ...
    /**
     * The access token value used to authenticate the request (normally in an
    ...
    /**
     * The access token type used to authenticate the request (normally in an
     * authorization header).
     *
    ...
    /**
     * The authentication details obtained by decoding the access token if
     * available.
     *
     ...
     * available.
     *
     * @param decodedDetails
     *            the decodedDetails to set
     */
