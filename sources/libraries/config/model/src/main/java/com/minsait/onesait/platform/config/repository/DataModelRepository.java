...
public interface DataModelRepository extends JpaRepository<DataModel, String> {
    ...
    @Query("SELECT o " + "FROM DataModel AS o " + "WHERE o.id LIKE %:id% OR " + "o.name LIKE %:name% OR " + "o" +
    ...
    @Override
    @CacheEvict(cacheNames = {"DataModelRepositoryAll", "DataModelRepositoryById", "DataModelRepositoryByName", "DataModelRepositoryByType"}, allEntries = true)
    void flush();
