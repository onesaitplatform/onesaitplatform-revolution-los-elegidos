...
public interface OntologyTimeSeriesPropertyRepository extends JpaRepository<OntologyTimeSeriesProperty, String> {
    ...
    @Query("SELECT o FROM OntologyTimeSeriesProperty AS o WHERE o.ontologyTimeSeries.ontology" +
            ".identification=:identification")
    @Cacheable(cacheNames = "OntologyTimeSeriesPropertyRepositoryByOntologyIdentification", unless = "#result==null " +
            "or #result.size()==0")
