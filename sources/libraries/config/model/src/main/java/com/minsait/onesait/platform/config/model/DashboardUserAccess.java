...
@Entity
@Table(name = "DASHBOARD_USER_ACCESS", uniqueConstraints = {@UniqueConstraint(columnNames = {"DASHBOARD_ID", "USER_ID"
})})
@Configurable
public class DashboardUserAccess extends AuditableEntityWithUUID {
    ...
    public boolean equals(Object o) {
        ...
        return getDashboardUserAccessType() != null && getDashboardUserAccessType().equals(
                that.getDashboardUserAccessType()) && getDashboard() != null && getDashboard().equals(
                that.getDashboard()) && getUser() != null && getUser().equals(that.getUser());
    }
