...
@Entity
@Table(name = "PIPELINE_USER_ACCESS", uniqueConstraints = {@UniqueConstraint(columnNames = {"PIPELINE_ID", "USER_ID"})})
@Configurable
public class PipelineUserAccess extends AuditableEntityWithUUID {
    ...
    public boolean equals(Object o) {
        ...
        return getPipelineUserAccessType() != null && getPipelineUserAccessType().equals(
                that.getPipelineUserAccessType()) && getPipeline() != null && getPipeline().equals(
                that.getPipeline()) && getUser() != null && getUser().equals(that.getUser());
    }
