...
public interface ClientPlatformOntologyRepository extends JpaRepository<ClientPlatformOntology, String> {
    ...
    @Cacheable(cacheNames = "ClientPlatformOntologyRepository", unless = "#result==null or #result.size()==0", key =
            "#p0.id")
    ...
    @Cacheable(cacheNames = "ClientPlatformOntologyRepositoryByOntology", unless = "#result==null or #result.size()" +
            "==0", key = "#p0.id")
    ...
    @Override
    @CacheEvict(cacheNames = {"ClientPlatformOntologyRepository",
            "ClientPlatformOntologyRepositoryByOntologyAndClientPlatform", "ClientPlatformOntologyRepositoryByOntology"}, allEntries = true)
    void flush();
