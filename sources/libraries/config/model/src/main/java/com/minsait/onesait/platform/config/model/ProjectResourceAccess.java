...
public class ProjectResourceAccess extends AuditableEntityWithUUID {
    ...
    public boolean equals(Object obj) {
        ...
        if (that != null && getAppRole() != null && that.getAppRole() != null)
            return (getAppRole().getId().equals(that.getAppRole().getId()) && getResource().getId().equals(
                    that.getResource().getId()) && getProject().getId().equals(that.getProject().getId()));
        else if (that != null && getUser() != null && that.getUser() != null)
            return (getUser().getUserId().equals(that.getUser().getUserId()) && getResource().getId().equals(
                    that.getResource().getId()) && getProject().getId().equals(that.getProject().getId()));
        else
