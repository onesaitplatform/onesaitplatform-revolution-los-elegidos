...
public interface SuscriptionModelRepository extends JpaRepository<SuscriptionNotificationsModel, String> {
    @Override
    @CacheEvict(cacheNames = {"SuscriptionModelRepositoryByOntologyName", "SuscriptionModelRepositoryBySubscriptionId"
    }, allEntries = true)
    ...
    @Cacheable(cacheNames = "SuscriptionModelRepositoryByOntologyName", unless = "#result==null or #result.size()==0"
            , key = "#p0")
