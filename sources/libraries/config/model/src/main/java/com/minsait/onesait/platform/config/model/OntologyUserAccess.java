...
@Entity
@Table(name = "ONTOLOGY_USER_ACCESS", uniqueConstraints = {@UniqueConstraint(columnNames = {"ONTOLOGY_ID", "USER_ID"})})
@Configurable
public class OntologyUserAccess extends AuditableEntityWithUUID {
    ...
    public boolean equals(Object o) {
        ...
        return getOntologyUserAccessType() != null && getOntologyUserAccessType().equals(
                that.getOntologyUserAccessType()) && getOntology() != null && getOntology().equals(
                that.getOntology()) && getUser() != null && getUser().equals(that.getUser());
    }
