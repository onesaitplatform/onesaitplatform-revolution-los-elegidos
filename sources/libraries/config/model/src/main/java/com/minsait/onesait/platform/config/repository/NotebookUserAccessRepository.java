...
public interface NotebookUserAccessRepository extends JpaRepository<NotebookUserAccess, String> {
    ...
    @Query("SELECT o FROM NotebookUserAccess AS o WHERE o.notebook=:id AND o.user=:user AND o" +
            ".notebookUserAccessType=:notebookUserAccessType")
    ...
    @Query("SELECT o FROM NotebookUserAccess AS o WHERE o.user=:user AND o" +
            ".notebookUserAccessType=:notebookUserAccessType")
