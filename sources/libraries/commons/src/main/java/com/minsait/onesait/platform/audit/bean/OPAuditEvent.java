...
public class OPAuditEvent implements Serializable {
    ...
    public String toString() {
        return "OPAuditEvent [message=" + message + ", id=" + id + ", type=" + type + ", timeStamp=" + timeStamp + "," +
                " user=" + user + ", ontology=" + ontology + ", operationType=" + operationType + ", module=" + module + ", extraData=" + extraData + ", otherType=" + otherType + ", result=" + resultOperation + "]";
    }
