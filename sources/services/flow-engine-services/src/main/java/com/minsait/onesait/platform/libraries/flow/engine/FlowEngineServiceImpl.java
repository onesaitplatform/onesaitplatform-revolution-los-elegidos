...
public class FlowEngineServiceImpl implements FlowEngineService {
    ...
    public List<FlowEngineDomainStatus> getAllFlowEnginesDomains() {
        ...
        try {
            ...
            response = (List<FlowEngineDomainStatus>) FlowEngineDomainStatus.fromJsonArrayToDomainStatus(
                    responseHttp.getBody());
        } catch (Exception e) {
    ...
    public List<FlowEngineDomainStatus> getFlowEngineDomainStatus(List<String> domainList) {
        ...
        try {
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(restBaseUrl + "/domain/status").queryParam(
                    "domainList", data.toString().substring(0, data.toString().length() - 1));
