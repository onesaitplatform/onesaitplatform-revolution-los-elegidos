...
public class OntologyBusinessServiceException extends Exception {
    ...
    public enum Error {
        ILLEGAL_ARGUMENT, NO_VALID_SCHEMA, KAFKA_TOPIC_CREATION_ERROR, CONFIG_CREATION_ERROR,
        CONFIG_CREATION_ERROR_UNCLEAN, PERSISTENCE_CREATION_ERROR, PERSISTENCE_CREATION_ERROR_UNCLEAN
    }
