...
public class VirtualDatasourceServiceImpl implements VirtualDatasourceService {
    ...
    public List<String> getAllIdentifications() {
        final List<OntologyVirtualDatasource> datasources =
                ontologyVirtualDatasourceRepository.findAllByOrderByDatasourceNameAsc();
    ...
    public Boolean changePublic(String datasource) {
        OntologyVirtualDatasource virtualDatasource = ontologyVirtualDatasourceRepository.findByDatasourceName(
                datasource);
    ...
    public Boolean checkConnectionExtern(String datasourceName) throws GenericOPException {
        OntologyVirtualDatasource ovdatasource = ontologyVirtualDatasourceRepository.findByDatasourceName(
                datasourceName);
