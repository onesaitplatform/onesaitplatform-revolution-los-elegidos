...
public class MigrationServiceTest {
    ...
    @Transactional
    @Ignore
    //this is a time consuming test, it is used just for development porpouse. Therefore it is not normally executed.
    public void given_All_When_IAsk_Then_IHaveAll() throws IOException, VersionNotSupportedException,
            NamespaceMismatchException, ProcessStepException, IOReadException, ClassNotFoundException,
    ...
    @Test
    @Transactional
    public void given_OneClientPlatform_When_ItIsImported_ItIsAddedToTheDatabase() throws IOException,
    ...
    @Test
    @Transactional
    public void given_AnExportedDevice_When_ItIsImported_ItIsAddedToTheDatabase() throws IOException,
            VersionNotSupportedException, NamespaceMismatchException, ProcessStepException, IOReadException,
            ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException,
            IllegalAccessException, InstantiationException {
    ...
    @Test
    @Transactional
    public void given_OneUserAndTwoOntologiesOfSuchUser_When_IsRequestedToObtainData_Then_TheDataAreObtainedWithWarningsInDataSchema() throws JsonGenerationException, JsonMappingException, IOException, IllegalArgumentException, IllegalAccessException {
    ...
    @Test
    @Transactional
    public void given_OneExportResultWithOneUserAndTwoOntologies_When_ItIsSerializedAndDeserialized_Then_FieldValuesAreNotLost() throws IOException, IllegalArgumentException, IllegalAccessException {
        ExportResult result = exportOneUserTwoOntologies();
    ...
    @Test
    @Transactional
    public void given_OneExportResultWithOneUserAndTwoOntologies_When_ItIsTransformedInJsonAndRestauredAsData_Then_FieldValuesAreNotLost() throws IllegalArgumentException, IllegalAccessException, JsonProcessingException, VersionNotSupportedException, NamespaceMismatchException, ProcessStepException, IOReadException {
        ExportResult result = exportOneUserTwoOntologies();
    ...
    @Test
    @Transactional
    public void given_OneClassInTheBlackList_When_ItIsExported_Then_ItisIgnored() throws IllegalArgumentException,
    ...
    @Test
    @Transactional
    public void given_OneOntologyInDB_When_ItIsPersistedOnDiskAndRestored_Then_TheEntityHasTheSameValuesThanInTheBegining() throws IllegalArgumentException, IllegalAccessException, IOException {
    ...
    @Test
    @Transactional
    public void given_OneNewOntologyAndOneUserInExportedFile_When_ItIsImportedIntoDBAndTheUserAlreadyExists_Then_TheOntologyIsStoredInDBAndTheUserIgnored() throws JsonParseException, JsonMappingException, IOException, ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, InstantiationException, VersionNotSupportedException, NamespaceMismatchException, ProcessStepException, IOReadException {
    ...
    @Test
    @Transactional
    public void given_AnExportedOntologyWithoutOneField_When_ItIsImported_Then_TheCorrectTransformationIsPerformed() throws IOException, VersionNotSupportedException, NamespaceMismatchException, ProcessStepException, IOReadException {
    ...
    @Test
    @Transactional
    public void given_OneConfigDBWithDefaultData_When_AllDataIsExported_Then_NoDataIsExported() throws IllegalArgumentException, IllegalAccessException {
