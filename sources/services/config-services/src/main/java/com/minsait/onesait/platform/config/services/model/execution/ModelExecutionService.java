...
public interface ModelExecutionService {
    ...
    ModelExecution create(ModelExecution modelExecution);

    List<ModelExecution> findAllExecutionModels();

    ModelExecution getModelExecutionById(String id);

    List<ModelExecution> findExecutionModelsByModel(Model model);
