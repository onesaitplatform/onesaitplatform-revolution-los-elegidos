...
public class MarketAssetServiceImpl implements MarketAssetService {
    ...
    public void updateMarketAsset(String id, MarketAsset marketAsset, String userId) throws GenericOPException {
        ...
        // list view
        if (!marketAsset.getUser().getUserId().equals(userId) && !user.getRole().toString().equals(
    ...
    private List<MarketAsset> filterByUserOrAproved(List<MarketAsset> marketAssetList, User user) {
        ...
        for (final MarketAsset marketAsset : marketAssetList) {
            if (marketAsset.getUser().getUserId().equals(user.getUserId()) || (marketAsset.getState().name().equals(
                    MarketAsset.MarketAssetState.APPROVED.name()) && marketAsset.isPublic())) {
    ...
    public void delete(String id, String userId) {
        ...
        if (user.getRole().getId().equals(Role.Type.ROLE_ADMINISTRATOR.name()) || marketAssetToDelete.getUser().equals(
                user)) {
