 ...
 */
package com.minsait.onesait.platform.config.services.ontologyrest;
...
@Service
public class OntologyRestServiceImpl implements OntologyRestService {
    ...
    @Override
    public OntologyRest getOntologyRestByIdentification(String identification) {
        Ontology ontology = ontologyRepository.findByIdentification(identification);
        if (ontology != null) {
            return ontologyRestRepository.findByOntologyId(ontology);
        }
        return null;
    }
