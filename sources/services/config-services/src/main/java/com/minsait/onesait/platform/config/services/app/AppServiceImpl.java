...
public class AppServiceImpl implements AppService {
        ...
        for (final AppRole role : app.getAppRoles()) {
            ...
            if (app.getProject() != null) {
                ...
                project.getProjectResourceAccesses().removeIf(
                        pra -> pra.getAppRole() != null && pra.getAppRole().equals(role));
    ...
    private void updateFatherAssociation(AppAssociatedCreateDTO association, App app) {
        ...
        final Optional<AppRole> fatherRoleOptional = app.getAppRoles().stream().filter(
                rolPadre -> rolPadre.getName().equals(association.getFatherRoleName())).findFirst();
        ...
        final Optional<AppRole> childRoleOptional = childApp.getAppRoles().stream().filter(
                rolHijo -> rolHijo.getName().equals(association.getChildRoleName())).findFirst();
    ...
    private void updateChildAssociation(AppAssociatedCreateDTO association, App app) {
        ...
        final Optional<AppRole> fatherRoleOptional = fatherApp.getAppRoles().stream().filter(
                rolPadre -> rolPadre.getName().equals(association.getFatherRoleName())).findFirst();
        ...
        AppRole childRole = null;
        final Optional<AppRole> childRoleOptional = app.getAppRoles().stream().filter(
                rolHijo -> rolHijo.getName().equals(association.getChildRoleName())).findFirst();
    ...
    private void deleteRolesApp(App app) {
        for (final AppRole role : app.getAppRoles()) {
    ...
    private void deleteChildApps(App app) {
    ...
    public void deleteAssociation(String fatherRoleName, String childRoleName, String fatherAppId, String childAppId) {
        ...
        if (fatherRole.getChildRoles().contains(childRole)) {
            ...
            if (fatherApp.getProject() != null) {
                ...
                project.getProjectResourceAccesses().removeIf(
                        pra -> pra.getAppRole() != null && pra.getAppRole().equals(childRole));
                projectService.updateProject(project);
            }
        }
    ...
    public boolean isUserInApp(String userId, String realmId) {
        List<AppUser> listUser = appUserRepository.findByUserId(userId, realmId);
