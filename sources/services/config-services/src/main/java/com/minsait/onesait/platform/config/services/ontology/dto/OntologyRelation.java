...
public class OntologyRelation implements Comparable<OntologyRelation>, Serializable {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof OntologyRelation))
            ...
            return (srcOntology.equals(other.getSrcOntology()) && dstOntology.equals(
                    other.getDstOntology()) && srcAttribute.equals(other.getSrcAttribute()) && dstAttribute.equals(
                    other.getDstAttribute()));
        }
    }
