...
public class StreamsetsApiWrapper {
    ...
    public final class OrderField {
        ...
        public static final String ALL_OPTIONS =
                NAME + "," + TITLE + "," + LAST_MODIFIED + "," + CREATED + "," + STATUS;
    }
    ...
    public final class Order {
        ...
        public static final String ALL_OPTIONS = ASC + "," + DESC;
    }
    ...
    public final class SystemLabel {
        ...
        public static final String ALL_OPTIONS =
                ALL_PIPELINES + "," + RUNNING_PIPELINES + "," + NON_RUNNING_PIPELINES + "," + INVALID_PIPES + "," + ERROR_PIPELINES + "," + SHARE_WITH_ME_PIPELINES;
    }
    ...
    public static String pipelineHistory(RestTemplate rt, HttpHeaders headers, String dataflowServiceUrl,
        ...
        String url = urlBuilder.append(dataflowServiceUrl).append(CONTEXT).append(VERSION).append(
                "/pipeline/{pipelineId}/history").toString();
        ...
        uri = UriComponentsBuilder.fromUri(uri).queryParam("rev", "0").queryParam("fromBeginning",
                                                                                  fromBeginning).build().toUri();
    ...
    public static ResponseEntity<String> pipelineStart(RestTemplate rt, HttpHeaders headers, String dataflowServiceUrl,
        ...
        StringBuilder urlBuilder = new StringBuilder();
        String url = urlBuilder.append(dataflowServiceUrl).append(CONTEXT).append(VERSION).append(
                "/pipeline/{pipelineId}/start").toString();
    ...
    public static ResponseEntity<String> pipelineStop(RestTemplate rt, HttpHeaders headers, String dataflowServiceUrl,
        ...
        StringBuilder urlBuilder = new StringBuilder();
        String url = urlBuilder.append(dataflowServiceUrl).append(CONTEXT).append(VERSION).append(
                "/pipeline/{pipelineId}/stop").toString();
    ...
    public static ResponseEntity<String> pipelineStatus(RestTemplate rt, HttpHeaders headers, String dataflowServiceUrl,
        ...
        StringBuilder urlBuilder = new StringBuilder();
        String url = urlBuilder.append(dataflowServiceUrl).append(CONTEXT).append(VERSION).append(
                "/pipeline/{pipelineId}/status").toString();
    ...
    public static ResponseEntity<String> pipelineExport(RestTemplate rt, HttpHeaders headers, String dataflowServiceUrl,
        ...
        // /rest/v1/pipeline/Algo7b511a1f-ad22-4afc-bf71-ca9b58d51040/export?rev=0&attachment=false
        // &includeLibraryDefinitions=true
        ...
        StringBuilder urlBuilder = new StringBuilder();
        String url = urlBuilder.append(dataflowServiceUrl).append(CONTEXT).append(VERSION).append(
                "/pipeline/{pipelineId}/export").toString();
        ...
        // add query parameters
        uri = UriComponentsBuilder.fromUri(uri).queryParam("rev", "0").queryParam("attachment", false).queryParam(
                "includeLibraryDefinitions", true).build().toUri();
    ...
    public static ResponseEntity<String> pipelineImport(RestTemplate rt, HttpHeaders headers, String dataflowServiceUrl,
        ...
        StringBuilder urlBuilder = new StringBuilder();
        String url = urlBuilder.append(dataflowServiceUrl).append(CONTEXT).append(VERSION).append(
                "/pipeline/{pipelineId}/import").toString();
        ...
        // add query parameters
        uri = UriComponentsBuilder.fromUri(uri).queryParam("rev", "0").queryParam("overwrite", override).queryParam(
                "autoGeneratePipelineId", autoGeneratePipelineId).queryParam("draft", false).build().toUri();
    ...
    public static ResponseEntity<String> pipelines(RestTemplate rt, HttpHeaders headers, String dataflowServiceUrl,
        ...
        // /rest/v1/pipelines?filterText=<filter>&label=<label>&offset=<offset>&len=<longitud>&orderBy=<orderField
        // >&order=<orderType>&includeStatus=true
        // /rest/v1/pipelines?filterText=kfk&label=system%3AallPipelines&offset=0&len=50&orderBy=NAME&order=ASC
        // &includeStatus=true
        ...
        //add query parameters
        uri = UriComponentsBuilder.fromUri(uri).queryParam(FILTER_TEXT, filterText).queryParam(LABEL, label).queryParam(
                OFFSET, Integer.toString(offset)).queryParam(LEN, Integer.toString(len)).queryParam(ORDER_BY,
                                                                                                    orderBy).queryParam(
                ORDER, order).queryParam(INCLUDE_STATUS, Boolean.toString(includeStatus)).build().toUri();

        return rt.exchange(uri, HttpMethod.GET, headersEntity, String.class);
    }

    public static ResponseEntity<String> pipelineMetrics(RestTemplate rt, HttpHeaders headers,
            String dataflowServiceUrl, String pipelineId) {
        // /rest/v1/pipelines?filterText=<filter>&label=<label>&offset=<offset>&len=<longitud>&orderBy=<orderField
        // >&order=<orderType>&includeStatus=true
        // /rest/v1/pipelines?filterText=kfk&label=system%3AallPipelines&offset=0&len=50&orderBy=NAME&order=ASC
        // &includeStatus=true
        ...
        StringBuilder urlBuilder = new StringBuilder();
        String url = urlBuilder.append(dataflowServiceUrl).append(CONTEXT).append(VERSION).append(
                "/pipeline/{pipelineId}/metrics").toString();
