...
public interface OntologyTimeSeriesService {
    ...
    public ResponseEntity<Map<String, String>> createOntologyTimeSeries(OntologyTimeSeriesDTO ontology,
            HttpServletRequest request) throws OntologyServiceException, OntologyDataJsonProblemException;
