...
public class MigrationError {
    ...
    public boolean equals(Object o) {
        ...
        return getNeededInstance() != null && getNeededInstance().equals(
                that.getNeededInstance()) && getProcessedInstance() != null && getProcessedInstance().equals(
                that.getProcessedInstance());
    }
