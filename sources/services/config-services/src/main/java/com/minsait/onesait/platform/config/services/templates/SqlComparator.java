...
public class SqlComparator {
    ...
    static void matchSelectItems(List<SelectItem> selectItems1, List<SelectItem> selectItems2, MatchResult result) {
        ...
        if (result.isMatch() && selectItems1 != null) {
            ...
            if (selectItems1.size() == selectItems2.size()) {
                ...
                if (SelectExpressionItem.class.equals(selectItems2.get(0).getClass()) && UserVariable.class.equals(
                        selectItem2.getExpression().getClass())) {
    ...
    static void matchSelectExpressionItem(SelectExpressionItem selectExpressionItem1,
        ...
        if (selectExpressionItem1.getExpression().getClass().equals(
                CaseExpression.class) || selectExpressionItem1.getExpression().getClass().equals(
                Function.class) || selectExpressionItem1.getExpression().getClass().equals(Parenthesis.class)) {
            ...
            if (result.isMatch() && selectExpressionItem1.getExpression() != null) {
                selectExpressionItem1.getExpression().accept(
                        new ExpressionVisitorComparator(selectExpressionItem2.getExpression(), result));
            }
        } else {
