...
public class ExpressionVisitorComparator extends ExpressionVisitorAdapter {
    ...
    private void processSameClassStatement(CaseExpression caseExpression1, CaseExpression caseExpression2) {
        caseExpression1.getSwitchExpression().accept(
                new ExpressionVisitorComparator(caseExpression2.getSwitchExpression(), result));
        if (result.isMatch()) {
            ...
            while (it1.hasNext() && it2.hasNext()) {
                ...
                if (result.isMatch()) {
                    when1.getThenExpression().accept(
                            new ExpressionVisitorComparator(when2.getThenExpression(), result));
            ...
            if (result.isMatch()) {
                caseExpression1.getElseExpression().accept(
                        new ExpressionVisitorComparator(caseExpression2.getElseExpression(), result));
            }
        }
    }
    ...
    public void visit(NotEqualsTo notEqualsTo1) {
        ...
        if (sameClass) {
            notEqualsTo1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(notEqualsTo2.getLeftExpression(), result));
            if (result.isMatch()) {
                notEqualsTo1.getRightExpression().accept(
                        new ExpressionVisitorComparator(notEqualsTo2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(MinorThanEquals minorThanEquals1) {
        ...
        if (sameClass) {
            minorThanEquals1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(minorThanEquals2.getLeftExpression(), result));
            if (result.isMatch()) {
                minorThanEquals1.getRightExpression().accept(
                        new ExpressionVisitorComparator(minorThanEquals2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(MinorThan minorThan1) {
        ...
        if (sameClass) {
            minorThan1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(minorThan2.getLeftExpression(), result));
            if (result.isMatch()) {
                minorThan1.getRightExpression().accept(
                        new ExpressionVisitorComparator(minorThan2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(LikeExpression likeExpression1) {
        ...
        if (sameClass) {
            likeExpression1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(likeExpression2.getLeftExpression(), result));
            if (result.isMatch()) {
                likeExpression1.getRightExpression().accept(
                        new ExpressionVisitorComparator(likeExpression2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(InExpression inExpression1) {
        ...
        if (sameClass) {
            inExpression1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(inExpression2.getLeftExpression(), result));
            if (result.isMatch()) {
                inExpression1.getRightItemsList().accept(
                        new ItemListVisitorComparator(inExpression2.getRightItemsList(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(GreaterThanEquals greaterThanEquals1) {
        ...
        if (sameClass) {
            greaterThanEquals1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(greaterThanEquals2.getLeftExpression(), result));
            if (result.isMatch()) {
                greaterThanEquals1.getRightExpression().accept(
                        new ExpressionVisitorComparator(greaterThanEquals2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(GreaterThan greaterThan1) {
        ...
        if (sameClass) {
            greaterThan1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(greaterThan2.getLeftExpression(), result));
            if (result.isMatch()) {
                greaterThan1.getRightExpression().accept(
                        new ExpressionVisitorComparator(greaterThan2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(EqualsTo equalsTo1) {
        ...
        if (sameClass) {
            equalsTo1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(equalsTo2.getLeftExpression(), result));
            if (result.isMatch()) {
                equalsTo1.getRightExpression().accept(
                        new ExpressionVisitorComparator(equalsTo2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(Between between1) {
        ...
        if (sameClass) {
            ...
            if (result.isMatch()) {
                between1.getBetweenExpressionStart().accept(
                        new ExpressionVisitorComparator(between2.getBetweenExpressionStart(), result));
                if (result.isMatch()) {
                    between1.getBetweenExpressionEnd().accept(
                            new ExpressionVisitorComparator(between2.getBetweenExpressionEnd(), result));
                }
            }
        } else {
            result.setResult(false);
    ...
    public void visit(OrExpression orExpression1) {
        ...
        if (sameClass) {
            orExpression1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(orExpression2.getLeftExpression(), result));
            if (result.isMatch()) {
                orExpression1.getRightExpression().accept(
                        new ExpressionVisitorComparator(orExpression2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(AndExpression andExpression1) {
        ...
        if (sameClass) {
            andExpression1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(andExpression2.getLeftExpression(), result));
            if (result.isMatch()) {
                andExpression1.getRightExpression().accept(
                        new ExpressionVisitorComparator(andExpression2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
    ...
    public void visit(Subtraction subtraction1) {
        ...
        if (sameClass) {
            subtraction1.getLeftExpression().accept(
                    new ExpressionVisitorComparator(subtraction2.getLeftExpression(), result));
            if (result.isMatch()) {
                subtraction1.getRightExpression().accept(
                        new ExpressionVisitorComparator(subtraction2.getRightExpression(), result));
            }
        } else {
            result.setResult(false);
        }
