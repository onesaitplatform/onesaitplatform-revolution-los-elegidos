...
public class JupyterConverterImpl implements JupyterConverter {
    ...
    private RuntimeTypeAdapterFactory<Cell> cellTypeFactory = RuntimeTypeAdapterFactory.of(Cell.class,
                                                                                           "cell_type").registerSubtype(
            MarkdownCell.class, "markdown").registerSubtype(CodeCell.class, "code").registerSubtype(RawCell.class,
                                                                                                    "raw").registerSubtype(
            HeadingCell.class, "heading");

    private RuntimeTypeAdapterFactory<Output> outputTypeFactory = RuntimeTypeAdapterFactory.of(Output.class,
                                                                                               "output_type").registerSubtype(
            ExecuteResult.class, "execute_result").registerSubtype(DisplayData.class, "display_data").registerSubtype(
            Stream.class, "stream").registerSubtype(Error.class, "error");
    ...
    private Gson getGson(GsonBuilder gsonBuilder) {
        return gsonBuilder.registerTypeAdapterFactory(cellTypeFactory).registerTypeAdapterFactory(
                outputTypeFactory).create();
    }
    ...
    public Note getNoteFromGson(String in, GsonBuilder gsonBuilder, String codeReplaced, String markdownReplaced) {
    ...
    private List<Paragraph> getParagraphs(Nbformat nbformat, String codeReplaced, String markdownReplaced,
    ...
    private String getLanguageFromData(String data) {
        ...
        try {
            ...
            JsonElement languageObject = jsonObject.getAsJsonObject("metadata").getAsJsonObject("kernelspec").get(
                    "language");
