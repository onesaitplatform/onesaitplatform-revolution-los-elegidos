...
public class DeviceSimulationServiceImpl implements DeviceSimulationService {
    ...
    public List<String> getClientOntologiesIdentification(String clientPlatformId) {
        ...
        for (Ontology ontology : this.ontologyService.getOntologiesByClientPlatform(
                this.clientPlatformRepository.findByIdentification(clientPlatformId))) {
    ...
    @Override
    public DeviceSimulation createSimulation(String identification, int interval, String userId,
        ...
        simulation.setOntology(
                this.ontologyService.getOntologyByIdentification(mapper.readTree(json).path("ontology").asText(),
                                                                 userId));
        simulation.setClientPlatform(this.clientPlatformRepository.findByIdentification(
                mapper.readTree(json).path("clientPlatform").asText()));
