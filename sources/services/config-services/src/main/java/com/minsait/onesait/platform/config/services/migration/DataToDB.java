...
public class DataToDB {
    ...
    public LoadEntityResult getEntitiesFromData(MigrationConfiguration config, DataFromDB data,
            EntityManager em) throws NoSuchFieldException, IllegalAccessException, InstantiationException,
    ...
    private Object getEntityFromData(Class<?> clazz, Serializable id, DataFromDB data, EntityManager em,
            MigrationErrors errors, EntityCache visited,
            MigrationConfiguration config) throws InstantiationException, IllegalAccessException,
            ClassNotFoundException {
                ...
                if (!Modifier.isFinal(field.getModifiers())) {
                    ...
                    if (value instanceof MigrationError) {
                        ...
                        MigrationError migrationError = new MigrationError(instanceThatNeedsIt,
                                                                           errorReturned.getNeededInstance(),
                                                                           MigrationError.ErrorType.ERROR,
                                                                           "The instance depends on a non available " +
                                                                                   "entity");
    ...
    private Object getCorrectValue(Object value, @SuppressWarnings("rawtypes") Class fieldType, Type type,
            ...
            Instance rootInstance) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        ...
        if (value != null) {
            ...
            if (Serializable.class.isAssignableFrom(valueClazz)) {
                ...
                if (MigrationUtils.isManagedEntity(em, fieldType)) {
                    ...
                    @SuppressWarnings("unchecked") Object entity = em.find(fieldType, sValue);
                    if (entity == null) {
                        if (data.isDataStored(fieldType, sValue)) {
                            ...
                            if (!config.contains(fieldType, sValue) && !entities.exist(fieldType,
                                                                                       sValue) && !entitiesWithErrors.exist(
                                    fieldType, sValue)) {
                                ...
                                MigrationError error = new MigrationError(rootInstance, instance,
                                                                          ...
                                                                          "Entity not configured added because other " +
                                                                                  "entity needs it");
            ...
            if (Date.class.isAssignableFrom(fieldType)) {
                ...
                @SuppressWarnings("unchecked") Collection<Object> newCollection = MigrationUtils.createCollection(
                        fieldType);
                ...
                @SuppressWarnings("unchecked") Object enumValue = Enum.valueOf(fieldType, (String) value);
                return enumValue;
