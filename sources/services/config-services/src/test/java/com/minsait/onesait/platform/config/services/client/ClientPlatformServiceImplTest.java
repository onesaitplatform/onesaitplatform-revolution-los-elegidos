...
public class ClientPlatformServiceImplTest {
    ...
    public void given_OneUserAdminWithClientPlatforms_When_AllClientPlatformsAreRequested_Then_AllTheClientPlatformOfTheUserAreReturned() {
        ...
        when(clientPlatformOntologyRepository.findByOntologyAndClientPlatform(id, clientIdentification)).thenReturn(
                cpo);

        List<ClientPlatform> allClientPlatformByCriteria = clientPlatformServiceImpl.getAllClientPlatformByCriteria(
                userId, clientIdentification, ontologies);
