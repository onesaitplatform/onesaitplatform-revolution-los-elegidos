...
public class OperationModel implements Serializable {
    ...
    public String toString() {
        return new StringBuilder().append("OperationModel [ontologyName=").append(ontologyName).append(
                ", operationType=").append(operationType).append(", user=").append(user).append(", source=").append(
                source).append(", body=").append(body).append(", queryType=").append(queryType).append(
                ", objectId=").append(objectId).append(", deviceTemplate=").append(deviceTemplate).append(
                ", device=").append(device).append(", clientSession=").append(clientSession).append(
                ", clientConnection=").append(clientConnection).append(", cacheable=").append(cacheable).append(
                "]").toString();
    }
