...
public class TestSimpleRule {
    private static final String RULE_DRL = "package com.minsait.onesait.platform.rulesengine;\n" + "import com" +
            ...
            ".platform.rulesengine.model.OntologyJsonWrapper ontology;\n" + "\n" + "dialect  \"mvel\"\n" + "\n" +
            "rule \"process ontology temperature\"\n" + "    when\n" + "        eval( ontology.getJsonProperty" +
            "(\"temperature\") > 30)\n" + "    then\n" + "        ontology.setJsonProperty(\"event\", \"Turn on the " +
            "air\");\n" + "end";

    private static final String RULE_ROLE = "package com.minsait.onesait.platform.rulesengine.roles;\n" + "import com" +
            ".minsait.onesait.platform.rulesengine.model.OntologyJsonWrapper;\n" + "global com.minsait.onesait" +
            ".platform.rulesengine.model.OntologyJsonWrapper ontology;\n" + "\n" + "dialect  \"mvel\"\n" + "\n" +
            "rule \"Assign role\"\n" + "    when\n" + "        eval( ontology.getJsonProperty(\"currentSalary\") < " +
            "1000000 && ontology.getJsonProperty(\"experienceInYears\") > 10 )\n" + "    then\n" + "        ontology" +
            ".setJsonProperty(\"role\", \"Manager\");\n" + "end";
    private static final String RULE_ROLE_2 = "package com.minsait.onesait.platform.rulesengine.roles;\n" + "import " +
            "com.minsait.onesait.platform.rulesengine.model.OntologyJsonWrapper;\n" + "global com.minsait.onesait" +
            ".platform.rulesengine.model.OntologyJsonWrapper ontology;\n" + "\n" + "dialect  \"mvel\"\n" + "\n" +
            "rule \"Assign role 2\"\n" + "    when\n" + "        eval( ontology.getJsonProperty(\"currentSalary\") < " +
            "1000000 && ontology.getJsonProperty(\"experienceInYears\") > 10 )\n" + "    then\n" + "        ontology" +
            ".setJsonProperty(\"role2\", \"Manager\");\n" + "end";
