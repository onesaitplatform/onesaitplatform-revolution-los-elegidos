...
public class SchedulerDefaultController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/pause/{jobName}", produces =
            MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/resume/{jobName}", produces =
            MediaType.APPLICATION_JSON_UTF8_VALUE)
