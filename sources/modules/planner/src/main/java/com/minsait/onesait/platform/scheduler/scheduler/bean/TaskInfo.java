...
public class TaskInfo {
    ...
    public TaskInfo(String jobName, String username, String cronExpression, SchedulerType schedulerType,
            Map<String, Object> data, boolean isSingleton, Date startAt, Date endAt) {
        super();
