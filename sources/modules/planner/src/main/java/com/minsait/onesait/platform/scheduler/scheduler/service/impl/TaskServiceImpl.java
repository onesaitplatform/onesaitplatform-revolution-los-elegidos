...
public class TaskServiceImpl implements TaskService {
    ...
    public List<ListTaskInfo> list(String username) {
        ...
        if (!user.getRole().getId().equals(Role.Type.ROLE_ADMINISTRATOR.name()) && !username.equals(user.getUserId())) {
                    ...
                    for (JobKey jobKey : scheduler.getJobKeys(GroupMatcher.<JobKey>groupEquals(groupJob))) {
                        ...
                        for (Trigger trigger : triggers) {
                            ...
                            ListTaskInfo info = new ListTaskInfo(jobKey.getName(), jobKey.getGroup(),
                                                                 ...
                                                                 SchedulerType.fromString(
                                                                         scheduler.getSchedulerName()).toString(),
    ...
    public boolean unscheduled(TaskOperation operation) {
        ...
        try {
            ...
            if (!user.getRole().getId().equals(Role.Type.ROLE_ADMINISTRATOR.name()) && !job.getUserId().equals(
                    user.getUserId())) {
