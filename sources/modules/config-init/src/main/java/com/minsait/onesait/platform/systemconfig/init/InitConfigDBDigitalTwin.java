...
public class InitConfigDBDigitalTwin {
    ...
    public void initDigitalTwinType() {
        ...
        if (digitalTwinTypeRepository.count() == 0) {
            ...
            type.setJson(
                    "{\"title\":\"Turbine\",\"links\":{\"properties\":\"thing/Turbine/properties\"," +
                            "\"actions\":\"thing/Turbine/actions\",\"events\":\"thing/Turbine/events\"}," +
                            "\"description\":\"Wind Turbine for electricity generation\"," +
                            "\"properties\":{\"rotorSpeed\":{\"type\":\"int\",\"units\":\"rpm\"," +
                            "\"direction\":\"out\",\"description\":\"Rotor speed\"}," +
                            "\"maxRotorSpeed\":{\"type\":\"int\",\"units\":\"rpm\",\"direction\":\"in_out\"," +
                            "\"description\":\"Max allowed speed for the rotor\"},\"power\":{\"type\":\"double\"," +
                            "\"units\":\"wat/h\",\"direction\":\"out\",\"description\":\"Current Power generated by " +
                            "the turbine\"},\"alternatorTemp\":{\"type\":\"double\",\"units\":\"celsius\"," +
                            "\"direction\":\"out\",\"description\":\"Temperature of the alternator\"}," +
                            "\"nacelleTemp\":{\"type\":\"double\",\"units\":\"celsius\",\"direction\":\"out\"," +
                            "\"description\":\"Temperature into the nacelle\"},\"windDirection\":{\"type\":\"int\"," +
                            "\"units\":\"degrees\",\"direction\":\"out\",\"description\":\"Wind direction\"}}," +
                            "\"actions\":{\"connectElectricNetwork\":{\"description\":\"Connect the turbine to the " +
                            "electric network to provide power\"}," +
                            "\"disconnectElectricNetwork\":{\"description\":\"Disconnect the turbine to the electric " +
                            "network to prevent problems\"},\"limitRotorSpeed\":{\"description\":\"Limits the rotor " +
                            "speed\"}},\"events\":{\"register\":{\"description\":\"Register the device into the " +
                            "plaform\"},\"updateshadow\":{\"description\":\"Updates the shadow in the plaform\"}," +
                            "\"ping\":{\"description\":\"Ping the platform to keepalive the device\"}," +
                            "\"log\":{\"description\":\"Log information in plaform\"}}}");
            type.setUser(getUserDeveloper());
            type.setLogic(
                    "var digitalTwinApi = Java.type('com.minsait.onesait.platform.digitaltwin.logic.api" +
                            ".DigitalTwinApi').getInstance();" + System.getProperty(
                            LINE_SEPARATOR) + "function init(){" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.log('Init TurbineHelsinki shadow');" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('alternatorTemp', 25.0);" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('power', 50000.2);" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('nacelleTemp', 25.9);" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('rotorSpeed', 30);" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('windDirection', 68);" + System.getProperty(
                            LINE_SEPARATOR) + "" + System.getProperty(
                            LINE_SEPARATOR) + DT_API_SEND_UPDATE_SHADOW + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.log('Send Update Shadow for init function');" + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "function main(){" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.log('New loop');" + System.getProperty(
                            LINE_SEPARATOR) + "    var alternatorTemp = digitalTwinApi.getStatusValue" +
                            "('alternatorTemp');" + System.getProperty(
                            LINE_SEPARATOR) + "" + System.getProperty(
                            LINE_SEPARATOR) + "    alternatorTemp ++;" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('alternatorTemp', alternatorTemp);" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('power', 50000.2);" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('nacelleTemp', 25.9);" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('rotorSpeed', 30);" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('windDirection', 68);" + System.getProperty(
                            LINE_SEPARATOR) + "" + System.getProperty(
                            LINE_SEPARATOR) + DT_API_SEND_UPDATE_SHADOW + System.getProperty(
                            LINE_SEPARATOR) + DT_API_LOG_SEND_UPDATE_SHADOW + System.getProperty(
                            LINE_SEPARATOR) + " " + System.getProperty(
                            LINE_SEPARATOR) + "   if(alternatorTemp>=30){" + System.getProperty(
                            LINE_SEPARATOR) + "      digitalTwinApi.sendCustomEvent('tempAlert');" + System.getProperty(
                            LINE_SEPARATOR) + "   }" + System.getProperty(LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "" + System.getProperty(
                            LINE_SEPARATOR) + "var onActionConnectElectricNetwork=function(data){ }" + System.getProperty(
                            LINE_SEPARATOR) + "var onActionDisconnectElectricNetwork=function(data){ }" + System.getProperty(
                            LINE_SEPARATOR) + "var onActionLimitRotorSpeed=function(data){ }");
            ...
            type.setJson(
                    "{\"title\": \"Sensehat\",\"links\": {\"properties\": \"thing/Sensehat/properties\",\"actions\": " +
                            "\"thing/Sensehat/actions\",\"events\": \"thing/Sensehat/events\"},\"description\": " +
                            "\"Raspberry - Sensehat\",\"properties\": {\"temperature\": {\"type\": \"double\"," +
                            "\"units\": \"degrees\",\"direction\": \"out\",\"description\": \"Temperature\"}," +
                            "\"humidity\": {\"type\": \"double\",\"units\": \"milibars\",\"direction\": \"out\"," +
                            "\"description\": \"Humidity\"},\"pressure\": {\"type\": \"double\",\"units\": \"%\"," +
                            "\"direction\": \"out\",\"description\": \"Pressure\"}},\"actions\": {\"joystickUp\": " +
                            "{\"description\": \"Joysctick action up\"},\"joystickRight\": {\"description\": " +
                            "\"Joystick action to the right\"},\"joystickDown\": {\"description\": \"Joystick action " +
                            "down\"},\"joystickLeft\": {\"description\": \"Joystick action to the left\"}," +
                            "\"joystickMiddle\": {\"description\": \"Joystick action to the middle\"}},\"events\": " +
                            "{\"ping\": {\"description\": \"Ping\"},\"register\": {\"description\": \"Register\"}," +
                            "\"log\": {\"description\": \"Log information in platform\"},\"joystickEventRigth\": " +
                            "{\"description\": \"Send joystick event to the right\"},\"joystickEventLeft\": " +
                            "{\"description\": \"Send joystick event to the left\"},\"joystickEventUp\": " +
                            "{\"description\": \"Send joystick event up\"},\"joystickEventDown\": {\"description\": " +
                            "\"Send joystick event down\"},\"joystickEventMiddle\": {\"description\": \"Send joystick" +
                            " event to the middle\"},\"updateShadow\": {\"description\": \"Send joystick event to the" +
                            " right\"}}}");
            type.setUser(getUserDeveloper());
            type.setLogic(
                    "var digitalTwinApi = Java.type('com.minsait.onesait.platform.digitaltwin.logic.api" +
                            ".DigitalTwinApi').getInstance();" + System.getProperty(
                            LINE_SEPARATOR) + "var senseHatApi = Java.type('com.minsait.onesait.platform.raspberry" +
                            ".sensehat.digitaltwin.api.SenseHatApi').getInstance();" + System.getProperty(
                            LINE_SEPARATOR) + "function init(){" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.setJoystickUpListener('joystickEventUp');" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.setJoystickDownListener('joystickEventDown')" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.setJoystickLeftListener('joystickEventLeft');" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.setJoystickRightListener('joystickEventRight');" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.setJoystickMiddleListener('joystickEventMiddle');" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Init SenseHatSpain shadow');" + System.getProperty(
                            LINE_SEPARATOR) + "   var sensorPress = senseHatApi.getPressure();" + System.getProperty(
                            LINE_SEPARATOR) + "   var sensorTemp = senseHatApi.getTemperature();" + System.getProperty(
                            LINE_SEPARATOR) + "   var sensorHum = senseHatApi.getHumidity();" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.setStatusValue('pressure', sensorPress);" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.setStatusValue('temperature', sensorTemp);" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.setStatusValue('humidity', sensorHum);" + System.getProperty(
                            LINE_SEPARATOR) + "    var temp = digitalTwinApi.getStatusValue('temperature');" + System.getProperty(
                            LINE_SEPARATOR) + "    var hum = digitalTwinApi.getStatusValue('humidity');" + System.getProperty(
                            LINE_SEPARATOR) + "    var pressure = digitalTwinApi.getStatusValue('pressure');" + System.getProperty(
                            LINE_SEPARATOR) + "    digitalTwinApi.log('Temperature: ' + temp + ' - Humidity: ' + hum " +
                            "+ ' - Pressure: '+ pressure);" + System.getProperty(
                            LINE_SEPARATOR) + DT_API_SEND_UPDATE_SHADOW + System.getProperty(
                            LINE_SEPARATOR) + DT_API_LOG_SEND_UPDATE_SHADOW + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "function main(){" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('New main execution');" + System.getProperty(
                            LINE_SEPARATOR) + "   var sensorPress = senseHatApi.getPressure();" + System.getProperty(
                            LINE_SEPARATOR) + "   var sensorTemp = senseHatApi.getTemperature();" + System.getProperty(
                            LINE_SEPARATOR) + "   var sensorHum = senseHatApi.getHumidity();" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.setStatusValue('pressure', sensorPress);" + System.getProperty(
                            ...
                            LINE_SEPARATOR) + DT_API_LOG_SEND_UPDATE_SHADOW + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "var joystickEventLeft=function(event){" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Received joystick event to the left');" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.sendCustomEvent('joystickEventLeft');" + System.getProperty(
                            LINE_SEPARATOR) + SENSE_HAT_API_SHOW_TEXT_LED_MATRIX + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "var joystickEventRight=function(event){" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Received joystick event to the right');" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.sendCustomEvent('joystickEventRight');" + System.getProperty(
                            LINE_SEPARATOR) + SENSE_HAT_API_SHOW_TEXT_LED_MATRIX + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "var joystickEventUp=function(event){" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Received joystick event up');" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.sendCustomEvent('joystickEventUp');" + System.getProperty(
                            LINE_SEPARATOR) + SENSE_HAT_API_SHOW_TEXT_LED_MATRIX + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "var joystickEventDown=function(event){" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Received joystick event down');" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.sendCustomEvent('joystickEventDown');" + System.getProperty(
                            LINE_SEPARATOR) + SENSE_HAT_API_SHOW_TEXT_LED_MATRIX + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "var joystickEventMiddle=function(event){" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Received joystick event to the middle');" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.sendCustomEvent('joystickEventMiddle');" + System.getProperty(
                            LINE_SEPARATOR) + SENSE_HAT_API_SHOW_TEXT_LED_MATRIX + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "var onActionJoystickRight=function(data){" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Received joystick action to the right');" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.showTextLedMatrix('Right');" + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "function onActionJoystickLeft(data){\r\n" + "   digitalTwinApi.log" +
                            "('Received joystick action to the left');" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.showTextLedMatrix('Left');" + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "var onActionJoystickUp=function(data){ " + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Received joystick action up');" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.showTextLedMatrix('Up');" + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "var onActionJoystickDown=function(data){" + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Received joystick action down');" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.showTextLedMatrix('Down');" + System.getProperty(
                            LINE_SEPARATOR) + "}" + System.getProperty(
                            LINE_SEPARATOR) + "var onActionJoystickMiddle=function(data){ " + System.getProperty(
                            LINE_SEPARATOR) + "   digitalTwinApi.log('Received joystick action to the middle');" + System.getProperty(
                            LINE_SEPARATOR) + "   senseHatApi.showTextLedMatrix('Middle');" + System.getProperty(
                            LINE_SEPARATOR) + "}");
