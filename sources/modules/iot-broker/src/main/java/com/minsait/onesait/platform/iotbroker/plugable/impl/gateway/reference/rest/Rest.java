...
@ConditionalOnProperty(prefix = "onesaitplatform.iotbroker.plugable.gateway.rest", name = "enable", havingValue =
        "true")
@RestController
...
public class Rest extends WebMvcConfigurerAdapter {
    ...
    public ResponseEntity<?> join(
            ...
            @ApiParam(value = "Client Platform asociated to token", required = true) @RequestParam(name =
    ...
    public ResponseEntity<?> leave(
            @ApiParam(value = "SessionKey provided from join operation", required = true) @RequestHeader(value =
                    "Authorization") String sessionKey) {
    ...
    public ResponseEntity<?> list(
            @ApiParam(value = "SessionKey provided from join operation", required = true) @RequestHeader(value =
                    "Authorization") String sessionKey,
            @ApiParam(value = "Ontology to perform operation. Client platform must have granted permissions ",
                    required = true) @PathVariable("ontology") String ontology,
            @ApiParam(value = "Examples:\n\tNATIVE: db.temperature.find({})\n\tSQL: select * from temperature; ",
                    required = true) @RequestParam(name = "query") String query,
    ...
    public ResponseEntity<?> updateById(
            ...
            @ApiParam(value = "Json data representing ontology instance", required = true) @RequestBody JsonNode data,
            @ApiParam(value = "Response Will include modidified Ids", required = false) @RequestParam(name = "ids",
                    required = false, defaultValue = "false") String ids) {
    ...
    public ResponseEntity<?> updateByQuery(
            ...
            @ApiParam(value = "Ontology to perform operation. Client platform must have granted permissions ",
                    required = true) @PathVariable("ontology") String ontology,
            @ApiParam(value = "Examples: NATIVE: db.temperature.update({\"location\":\"Helsinki\"}, { " +
                    "$set:{\"value\":15}})", required = true) @RequestParam(name = "query") String query,
            @ApiParam(value = "Response Will include modidified Ids", required = false) @RequestParam(name = "ids",
                    required = false, defaultValue = "false") String ids) {
    ...
    public ResponseEntity<?> updateByQueryBody(
            ...
            @ApiParam(value = "Ontology to perform operation. Client platform must have granted permissions ",
                    required = true) @PathVariable("ontology") String ontology,
            @ApiParam(value = "Examples: NATIVE: db.temperature.update({\"location\":\"Helsinki\"}, { " +
                    "$set:{\"value\":15}})", required = true, example = "") @RequestBody String query,
            @ApiParam(value = "Response Will include modidified Ids", required = false) @RequestParam(name = "ids",
                    required = false, defaultValue = "false") String ids) {
    ...
    public ResponseEntity<?> deleteByQuery(
            ...
            @ApiParam(value = "Response Will include modidified Ids", required = false) @RequestParam(name = "ids",
                    required = false, defaultValue = "false") String ids) throws UnsupportedEncodingException {
