...
public class FlowEngineController {
    ...
    public @ResponseBody
    String stopFlowEngine() {
        return nodeRedClientAdmin.stopFlowEngine();
    }

    @RequestMapping(value = "/domain/stop/{domainId}", method = RequestMethod.PUT, produces =
            MediaType.APPLICATION_JSON_UTF8_VALUE)
    public @ResponseBody
    void stopFlowEngineDomain(@PathVariable(value = "domainId") String domainId) {
        nodeRedClientAdmin.stopFlowEngineDomain(domainId);
    }

    @RequestMapping(value = "/domain/start", method = RequestMethod.POST, produces =
            MediaType.APPLICATION_JSON_UTF8_VALUE)
    public @ResponseBody
    String startFlowEngineDomain(@RequestBody FlowEngineDomain domain) {
    ...
    public @ResponseBody
    String createFlowengineDomain(@RequestBody FlowEngineDomain domain) {
        return nodeRedClientAdmin.createFlowengineDomain(domain);
    }

    @RequestMapping(value = "/domain/{domainId}", method = RequestMethod.DELETE, produces =
            MediaType.APPLICATION_JSON_UTF8_VALUE)
    public @ResponseBody
    void deleteFlowEngineDomain(@PathVariable(value = "domainId") String domainId) {
        nodeRedClientAdmin.deleteFlowEngineDomain(domainId);
    }

    @RequestMapping(value = "/domain/{domainId}", method = RequestMethod.GET, produces =
            MediaType.APPLICATION_JSON_UTF8_VALUE)
    public @ResponseBody
    FlowEngineDomain getFlowEngineDomain(@PathVariable(value = "domainId") String domainId) {
    ...
    public @ResponseBody
    List<FlowEngineDomainStatus> getAllFlowEnginesDomains() {
        return nodeRedClientAdmin.getAllFlowEnginesDomains();
    }

    @RequestMapping(value = "/domain/status", method = RequestMethod.GET, produces =
            MediaType.APPLICATION_JSON_UTF8_VALUE)
    public @ResponseBody
    List<FlowEngineDomainStatus> getFlowEngineDomainStatus(@RequestParam List<String> domainList) {
    ...
    public @ResponseBody
    String synchronizeMF(@RequestBody List<FlowEngineDomainStatus> domainList) {
