...
public class FlowEngineAuditableAspect extends BaseAspect {
    ...
    private static final String EXECUTE_FLOWENGINE_AUDITABLE = "execute aspect flowengineAuditable method " +
            "doRecoveryActions";
    ...
    @AfterReturning(returning = "retVal", pointcut = "@annotation(auditable) && args(domain,..)" + " && execution (* " +
            "com.minsait.onesait.platform.flowengine.nodered.communication.NodeRedAdminClientImpl" +
            ".startFlowEngineDomain(..))")
    ...
    @AfterReturning(pointcut = "@annotation(auditable) && args(domainId,..)" + " && execution (* com.minsait.onesait" +
            ".platform.flowengine.nodered.communication.NodeRedAdminClientImpl.stopFlowEngineDomain(..))")
    ...
    @AfterReturning(pointcut = "@annotation(auditable) && args(domainId,..)" + " && execution (* com.minsait.onesait" +
            ".platform.flowengine.nodered.communication.NodeRedAdminClientImpl.deleteFlowEngineDomain(..))")
    ...
    @AfterReturning(returning = "retVal", pointcut = "@annotation(auditable) && args(ontologyIdentificator, " +
            "queryType, query, authentication,..)" + " && execution (* com.minsait.onesait.platform.flowengine.api" +
            ".rest.service.impl.FlowEngineNodeServiceImpl.submitQuery(..))")
    ...
    @AfterReturning(returning = "retVal", pointcut = "@annotation(auditable) && args(ontology, data, authentication,." +
            ".)" + " && execution (* com.minsait.onesait.platform.flowengine.api.rest.service.impl" +
            ".FlowEngineNodeServiceImpl.submitInsert(..))")
    ...
    @AfterThrowing(pointcut = "@annotation(auditable) && args(domain,..)" + " && (execution (* com.minsait.onesait" +
            ".platform.flowengine.nodered.communication.NodeRedAdminClientImpl.startFlowEngineDomain(..))" + " || " +
            "execution (* com.minsait.onesait.platform.flowengine.nodered.communication.NodeRedAdminClientImpl" +
            ".createFlowengineDomain(..)))", throwing = "ex")
    ...
    @AfterThrowing(pointcut = "@annotation(auditable) && args(domain,..)" + " && (execution (* com.minsait.onesait" +
            ".platform.flowengine.nodered.communication.NodeRedAdminClientImpl.stopFlowEngineDomain(..))" + " || " +
            "execution (* com.minsait.onesait.platform.flowengine.nodered.communication.NodeRedAdminClientImpl" +
            ".deleteFlowEngineDomain(..)))", throwing = "ex")
    ...
    public void doRecoveryActionsFlowEngineNodeQuery(JoinPoint joinPoint, FlowEngineAuditable auditable, Exception ex,
        ...
        try {
            Method method = getMethod(joinPoint);
            String message =
                    EXCEPTION_DETECTED + method.getName() + ", " + "operation query on ontology " + ontology + " with" +
                            " query " + query;
    ...
    @AfterThrowing(pointcut = "@annotation(auditable) && args(ontology,data,authentication,..)" + " && execution (* com.minsait.onesait.platform.flowengine.nodered.communication.NodeRedAdminClientImpl.submitInsert(..))", throwing = "ex")
    public void doRecoveryActionsFlowEngineNodeInsert(JoinPoint joinPoint, FlowEngineAuditable auditable, Exception ex,
        ...
        try {
            Method method = getMethod(joinPoint);
            String message = EXCEPTION_DETECTED + method.getName() + ", " + "Operation insert on ontology " + ontology + " with data " + data;
