...
public class NodeRedAdminClientImpl implements NodeRedAdminClient {
    ...
    public FlowEngineDomain getFlowEngineDomain(String domainId) {
        ...
        try {
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(
                    flowengineUrl + flowEngineDomainGet).queryParam("domain", domainId);
    ...
    public List<FlowEngineDomainStatus> getAllFlowEnginesDomains() {
        ...
        try {
            ...
            domainStatus = (List<FlowEngineDomainStatus>) FlowEngineDomainStatus.fromJsonArrayToDomainStatus(
                    responseRest);
        } catch (Exception e) {
    ...
    public List<FlowEngineDomainStatus> getFlowEngineDomainStatus(List<String> domainList) {
        ...
        try {
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(
                    flowengineUrl + flowEngineDomainStatus).queryParam("domains",
                                                                       mapper.writeValueAsString(domainList));
