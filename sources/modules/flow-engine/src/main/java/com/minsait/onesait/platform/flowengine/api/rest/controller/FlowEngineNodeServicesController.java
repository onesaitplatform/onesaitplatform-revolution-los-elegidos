...
public class FlowEngineNodeServicesController {
    ...
    public @ResponseBody
    ResponseEntity<String> deploymentNotification(@RequestBody String json) {
    ...
    public @ResponseBody
    String getApiRestCategories(@RequestParam String authentication,
    ...
    public @ResponseBody
    String getApiRestByUser(@RequestParam String authentication,
            @RequestParam("callback") String callbackName) throws JsonProcessingException {
    ...
    public @ResponseBody
    String getApiRestOperationsByUser(@RequestParam("apiName") String apiName, @RequestParam("version") Integer version,
            @RequestParam String authentication,
            @RequestParam("callback") String callbackName) throws JsonProcessingException {
        String response = mapper.writeValueAsString(
                flowEngineNodeService.getApiRestOperationsByUser(apiName, version, authentication));
        return callbackName + "(" + response + ")";
    }

    @GetMapping(value = "/user/ontologies", produces = {"application/javascript", "application/json"})
    public @ResponseBody
    String getOntologiesByUser(@RequestParam String authentication,
            @RequestParam("callback") String callbackName) throws JsonProcessingException {
    ...
    public @ResponseBody
    String getClientPlatformsByUser(@RequestParam String authentication) throws JsonProcessingException {
    ...
    public @ResponseBody
    String getClientPlatformsByUser(@RequestBody UserDomainValidationRequest request) {
        return flowEngineNodeService.validateUserDomain(request);
    }

    @GetMapping(value = "/user/all_data", produces = {"application/javascript"})
    public @ResponseBody
    String getOntologiesAndClientPlatformsByUser(@RequestParam String authentication) throws JsonProcessingException {
        String ontologies = mapper.writeValueAsString(flowEngineNodeService.getOntologyByUser(authentication));
        String clientPlatforms = mapper.writeValueAsString(
                flowEngineNodeService.getClientPlatformByUser(authentication));
    ...
    public @ResponseBody
    String submitQuery(
            @RequestBody FlowEngineQueryRequest queryRequest) throws JsonProcessingException, NotFoundException {
    ...
    public @ResponseBody
    String submitInsert(
            @RequestBody FlowEngineInsertRequest insertRequest) throws JsonProcessingException, NotFoundException {
    ...
    public @ResponseBody
    String getdigitalTwinTypes(@RequestParam String authentication,
            @RequestParam("callback") String callbackName) throws JsonProcessingException {
        String response = mapper.writeValueAsString(flowEngineNodeService.getDigitalTwinTypes(authentication));
        return callbackName + "(" + response + ")";
    }

    @PostMapping(value = "/user/invoke_rest_api_operation", produces = MediaType.APPLICATION_JSON_UTF8_VALUE,
            consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public @ResponseBody
    ResponseEntity<String> invokeRestApiOperation(@RequestBody FlowEngineInvokeRestApiOperationRequest invokeRequest) {
    ...
    public @ResponseBody
    String sendMail(@RequestBody MailRestDTO mailData) {
    ...
    public @ResponseBody
    String sendsimpleMail(@RequestBody MailRestDTO mailData) {
