...
public final class OperationFIQL {
    ...
    private static boolean isValidOperacion(String operacion) {
        return (operacion.equalsIgnoreCase(ApiOperation.Type.DELETE.name()) || operacion.equalsIgnoreCase(
                ApiOperation.Type.POST.name()) || operacion.equalsIgnoreCase(
                ApiOperation.Type.PUT.name()) || operacion.equalsIgnoreCase(ApiOperation.Type.GET.name()));
    }
}
