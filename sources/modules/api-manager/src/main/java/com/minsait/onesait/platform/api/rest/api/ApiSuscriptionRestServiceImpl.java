...
public class ApiSuscriptionRestServiceImpl implements ApiSuscriptionRestService {
    ...
    public Response getApiSuscripciones(String identificacionApi, String tokenUsuario) throws GenericOPException {
        return Response.ok(apiSuscripcionFIQL.toApiSuscripcionDTO(
                apiService.findApiSuscriptions(identificacionApi, tokenUsuario))).build();
    }

    @Override
    public Response getApiSuscripcionesUsuario(String identificacionUsuario,
            String tokenUsuario) throws GenericOPException {
        return Response.ok(apiSuscripcionFIQL.toApiSuscripcionesDTO(
                apiService.findApiSuscripcionesUser(identificacionUsuario))).build();
    }
