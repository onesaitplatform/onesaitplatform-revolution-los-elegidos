...
public class RestSwaggerReaderHelper {
    ...
    private static boolean isStringType(String dataType) {
        return dataType.equalsIgnoreCase("date") || dataType.equalsIgnoreCase("date-time") || dataType.equalsIgnoreCase(
                "object") || dataType.equalsIgnoreCase("password") || dataType.equalsIgnoreCase(
                "byte") || dataType.equalsIgnoreCase("binary") || dataType.equalsIgnoreCase(
                "email") || dataType.equalsIgnoreCase("uuid") || dataType.equalsIgnoreCase(
                "uri") || dataType.equalsIgnoreCase("hostname") || dataType.equalsIgnoreCase("ipv4");
    }
