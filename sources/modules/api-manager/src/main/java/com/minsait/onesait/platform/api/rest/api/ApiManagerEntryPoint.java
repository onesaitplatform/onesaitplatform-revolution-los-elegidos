    ...
    public ResponseEntity<String> processRequest(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (null != metricsManager) {
                ...
                } else if ((Api) mData.get(ApiServiceInterface.API) != null && ((Api) mData.get(
                        ApiServiceInterface.API)).getOntology() != null) {
                ...
                if (mData.get(ApiServiceInterface.USER) != null) {
                    metricsManager.logMetricApiManager(mData.get(ApiServiceInterface.USER).toString(), ontologyName,
                                                       mData.get(ApiServiceInterface.METHOD).toString(),
                                                       Source.APIMANAGER,
                                                       mData.get(ApiServiceInterface.HTTP_RESPONSE_CODE) == null
                                                               ? String.valueOf(HttpStatus.OK) : mData.get(
                                                               ApiServiceInterface.HTTP_RESPONSE_CODE).toString(),
