...
public final class QueryParameterFIQL {
    ...
    private static boolean isValidHeaderType(String datatype) {
        return (datatype.equalsIgnoreCase(ApiQueryParameter.HeaderType.BODY.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.HeaderType.PATH.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.HeaderType.QUERY.name()));
    }

    private static boolean isValidType(String datatype) {
        return (datatype.equalsIgnoreCase(ApiQueryParameter.DataType.STRING.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.ARRAY.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.DATE.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.OBJECT.name()) || datatype.equalsIgnoreCase(
                "boolean") || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.URI.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.PASSWORD.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.NUMBER.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.BINARY.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.EMAIL.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.HOSTNAME.name()) || datatype.equalsIgnoreCase(
                ApiQueryParameter.DataType.UUID.name())
