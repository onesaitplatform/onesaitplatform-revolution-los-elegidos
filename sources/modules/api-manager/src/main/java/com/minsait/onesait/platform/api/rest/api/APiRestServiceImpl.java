...
public class APiRestServiceImpl implements ApiRestService {
    ...
    @Override
    public Response getApiFilter(String identificacion, String estado, String usuario,
    ...
    @Override
    public Response deleteByIdentificacionNumversion(String identificacion, String numversion,
            String tokenUsuario) throws GenericOPException {
        final User user = apiSecurityService.getUserByApiToken(tokenUsuario);
        if (user == null)
            return Response.status(Status.UNAUTHORIZED).build();
