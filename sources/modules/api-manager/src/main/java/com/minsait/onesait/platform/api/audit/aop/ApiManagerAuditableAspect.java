...
public class ApiManagerAuditableAspect extends BaseAspect {
    ...
    @Around(value = "@annotation(auditable) && args(data,..) && execution (* com.minsait.onesait.platform.api" +
            ".processor.*.process(..))")
    public Object processQuery(ProceedingJoinPoint joinPoint, ApiManagerAuditable auditable,
            Map<String, Object> data) throws java.lang.Throwable {
