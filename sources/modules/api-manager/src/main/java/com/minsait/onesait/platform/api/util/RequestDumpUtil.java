...
public class RequestDumpUtil {
    ...
    public void dumpRequest(StringBuilder sb, HttpServletRequest request) {
        sb.append(INDENT).append("[Class] ").append(request.getClass().getName()).append(
                ", instance=" + request.toString().trim()).append(LF);
        ...
        sb.append(INDENT).append("[Locales] ").append(
                Collections.list(request.getLocales()).stream().map(loc -> loc.toString()).collect(
                        Collectors.joining(", "))).append(LF);
    ...
    public void dumpRequestSessionAttribute(StringBuilder sb, HttpServletRequest request) {
        ...
        if (session != null) {
            ...
            while (aNames.hasMoreElements()) {
                ...
                sb.append(INDENT).append("[session] ").append(name).append("=").append(
                        session.getAttribute(name)).append(LF);
            }
        }
    }
