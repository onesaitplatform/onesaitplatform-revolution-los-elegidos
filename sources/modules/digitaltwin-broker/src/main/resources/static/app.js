...
$(document).ready(function () {
    ...
    $.ajax({
        url: "/digitaltwinbroker/sensehat/getSensehatDevices", type: 'GET',
...
function sendCustomLeftEvent() {
    ...
    $("#left").show();
    $("#right").hide();
    stompClient.send("/api/sendAction", {'Authorization': $("#digitaltwin_key").val()}, JSON.stringify({
        'id': $("#devices").val(),
        'name': 'joystickLeft'
    }));
}
