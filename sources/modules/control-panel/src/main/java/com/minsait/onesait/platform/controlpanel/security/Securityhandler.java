...
public class Securityhandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        if (session != null) {
            ...
            if (authentication.getAuthorities().toArray()[0].toString().equals(
                    Role.Type.ROLE_PREVERIFIED_ADMINISTRATOR.name())) {
    ...
    public FilterRegistrationBean preVerifiedUsersFilter() {
        ...
        filter.setFilter(new OncePerRequestFilter() {
            ...
            protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
                ...
                if (auth != null && auth.getAuthorities().toArray()[0].toString().equals(
                        Role.Type.ROLE_PREVERIFIED_ADMINISTRATOR.name())) {
