...
public class ConfigurationRestService {
    ...
    public ResponseEntity<?> getAll() {
        final List<ConfigurationSimplified> configurations = configurationService.getAllConfigurations().stream().map(
                c -> new ConfigurationSimplified(c)).collect(Collectors.toList());
    ...
    public ResponseEntity<?> get(
        ...
        if (configuration == null)
            return new ResponseEntity<>(
                    "No configuration for realm " + realm + " of type " + type.name() + " and environment " + environment,
