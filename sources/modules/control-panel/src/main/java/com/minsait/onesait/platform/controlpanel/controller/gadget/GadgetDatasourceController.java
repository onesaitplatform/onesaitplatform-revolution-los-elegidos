...
public class GadgetDatasourceController {
    ...
    public String list(Model uiModel, HttpServletRequest request) {
        ...
        List<GadgetDatasource> datasource =
                this.gadgetDatasourceService.findGadgetDatasourceWithIdentificationAndDescription(
    ...
    public @ResponseBody
    List<GadgetDatasource> getUserGadgetDatasources() {
    ...
    public @ResponseBody
    GadgetDatasource getDatasourceById(@PathVariable("id") String id) {
    ...
    public @ResponseBody
    GadgetDatasource getDatasourceByIdentification(@PathVariable("id") String id) {
    ...
    public @ResponseBody
    String getSampleDatasource(@PathVariable("id") String datasourceId) {
    ...
    public @ResponseBody
    String deleteFromGadget(String id) {
        try {
    ...
    public @ResponseBody
    String createDataSourceFromGadget(GadgetDatasourceDTO gadgetDatasourceDTO) {
        ...
        try {
            ...
            gadgetDatasource.setOntology(
                    ontologyService.getOntologyByIdentification(gadgetDatasourceDTO.getOntologyIdentification(),
    ...
    public @ResponseBody
    String updateGadgetDatasourceFromGadget(@PathVariable("id") String id, GadgetDatasource gadgetDatasource) {
        if (!gadgetDatasourceService.hasUserPermission(id, this.utils.getUserId()))
            return ERROR_TRUE_STR;
        try {
