...
public class MarketAssetHelper {
    ...
    public void populateMarketAssetUpdateForm(Model model, String id) throws GenericOPException {
        ...
        // list view
        if (!marketAsset.getUser().equals(user) && !user.getRole().getId().equals(
    ...
    public String getApiDescription(String apiData) {
        ...
        try {
            ...
            final String srcSwagger = resourcesService.getUrl(Module.APIMANAGER,
                                                              ServiceUrl.BASE) + "swagger-ui.html?url=" + apiServices + "/management/swagger/v" + api.getNumversion() + "/" + api.getIdentification() + "/swagger.json";
