...
public class SwaggerConfig {
    ...
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder().title(INFO_TITLE).description(INFO_DESCRIPTION).termsOfServiceUrl(
                CONTACT_URL).contact(new Contact(CONTACT_NAME, CONTACT_URL, CONTACT_EMAIL)).license(
                INFO_VERSION).licenseUrl(LICENSE_URL).version(LICENSE_NAME).build();
    }
    ...
    public Docket apiOpsAPI() {
        ...
        aParameterBuilder.name(AUTH_STR).modelRef(new ModelRef(STRING_STR)).parameterType(HEADER_STR).required(
                true).build();
        aParameters.add(aParameterBuilder.build());

        return new Docket(DocumentationType.SWAGGER_2).groupName("All groups").select().apis(
                RequestHandlerSelectors.any()).paths(buildPathSelectorApiOps()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket loginOpsAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Authentication").select().apis(
                RequestHandlerSelectors.any()).paths(buildPathSelectorApiOpsLogin()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket apis() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("APIs").select().apis(
                RequestHandlerSelectors.any()).paths(buildPathSelectorApis()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket devices() {
        ...
        aParameterBuilder.name(AUTH_STR).modelRef(new ModelRef(STRING_STR)).parameterType(HEADER_STR).required(
                true).build();
        aParameters.add(aParameterBuilder.build());
        return new Docket(DocumentationType.SWAGGER_2).groupName("Devices").select().apis(
                RequestHandlerSelectors.any()).paths(buildPathSelectorDevices()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket notebookOpsAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Notebooks").select().apis(
                RequestHandlerSelectors.any()).paths(buildPathSelectorNotebookOps()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket userManagementAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Users").select().apis(
                RequestHandlerSelectors.any()).paths(
                buildPathSelectorUserManagement()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket realmManagementAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Realms").select().apis(
                RequestHandlerSelectors.any()).paths(
                buildPathSelectorRealmManagement()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket deploymentAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Deployment").select().apis(
                RequestHandlerSelectors.any()).paths(
                buildPathSelectorDeploymentManagement()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket dashboardsAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Dashboards").select()
                ...
                .apis(RequestHandlerSelectors.any()).paths(
                        buildPathSelectorDashoardsManagement()).build().globalOperationParameters(
                        addRestParameters(aParameterBuilder, aParameters)).produces(produces);
    }
    ...
    public Docket dataflowAPI() {
        ...
        aParameters.add(aParameterBuilder.build());
        final Set<String> produces = new HashSet<>(Arrays.asList(APP_JSON, APP_YAML, TEXT_PL));
        return new Docket(DocumentationType.SWAGGER_2).groupName("Dataflows").select().apis(
                RequestHandlerSelectors.any()).paths(
                buildPathSelectorDataflowsManagement()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters)).produces(produces);
    }
    ...
    public Docket cacheAPI() {
        ...
        aParameters.add(aParameterBuilder.build());
        final Set<String> produces = new HashSet<>(Arrays.asList(APP_JSON, APP_YAML, TEXT_PL));
        return new Docket(DocumentationType.SWAGGER_2).groupName("Cache").select().apis(
                RequestHandlerSelectors.any()).paths(
                buildPathSelectorCacheManagement()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters)).produces(produces);
    }
    ...
    public Docket layerssAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Layers").select().apis(RequestHandlerSelectors.any())
                ...
                .paths(buildPathSelectorLayersManagement()).build().globalOperationParameters(
                        addRestParameters(aParameterBuilder, aParameters)).produces(produces);
    }
    ...
    public Docket modelssAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Models").select().apis(RequestHandlerSelectors.any())
                ...
                .paths(buildPathSelectorModelsManagement()).build().globalOperationParameters(
                        addRestParameters(aParameterBuilder, aParameters)).produces(produces);
    }
    ...
    public Docket configurationAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Configurations").select()
                ...
                .apis(RequestHandlerSelectors.any()).paths(
                        buildPathSelectorConfigurationManagement()).build().globalOperationParameters(
                        addRestParameters(aParameterBuilder, aParameters)).produces(produces);
    }
    ...
    public Docket videobrokerAPI() {
        ...
        aParameterBuilder.name(AUTH_STR).modelRef(new ModelRef(STRING_STR)).parameterType(HEADER_STR).required(
                true).build();
        aParameters.add(aParameterBuilder.build());
        return new Docket(DocumentationType.SWAGGER_2).groupName("Videobroker").select().apis(
                RequestHandlerSelectors.any()).paths(
                buildPathSelectorVideobrokerManagement()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket ontologyManagementAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Ontologies").select().apis(
                RequestHandlerSelectors.any()).paths(
                buildPathSelectorOntologyManagement()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket reportsApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Reports").select().apis(
                RequestHandlerSelectors.any()).paths(buildPathSelectorReportsApi()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket microservicesApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Microservices").select().apis(
                RequestHandlerSelectors.any()).paths(buildPathSelectorMicroservicesApi()).build()
    ...
    public Docket mailManagementAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Mail").select().apis(
                RequestHandlerSelectors.any()).paths(
                buildPathSelectorMailManagement()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
    ...
    public Docket binaryAPI() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("Binary").select().apis(
                RequestHandlerSelectors.any()).paths(
                buildPathSelectorBinaryManagement()).build().globalOperationParameters(
                addRestParameters(aParameterBuilder, aParameters));
    }
