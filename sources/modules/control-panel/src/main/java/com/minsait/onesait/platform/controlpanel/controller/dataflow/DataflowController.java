...
public class DataflowController {
    ...
    public ResponseEntity<String> createPipeline(@PathVariable("name") String name,
        ...
        try {
            final String idstreamsets = dataflowService.createPipeline(name, type, description,
                                                                       utils.getUserId()).getIdstreamsets();
    ...
    public ResponseEntity<String> pipelineRestUserJSON(Model uiModel, HttpServletRequest request,
            ...
            @PathVariable("id") String id) throws URISyntaxException, IOException {
    ...
    public ResponseEntity<PipelineUserAccess> createAuthorization(@RequestParam String accesstype,
        ...
        try {
            ...
            final PipelineUserAccessType pipelineUserAccessTypeObject = pipelineUserAccessTypeRepository.findById(
                    accesstype);
            final PipelineUserAccess pipelineUserAccess = pipelineUserAccessRepository.findByPipelineAndUserAndAccess(
                    pipelineObject, userObject, pipelineUserAccessTypeObject);
    ...
    @ResponseBody
    public ResponseEntity<byte[]> analyAppRestBinary(Model uiModel,
