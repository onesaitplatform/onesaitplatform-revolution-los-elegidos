...
public class LayerController {
    ...
    public ResponseEntity<Map<String, String>> getOntologyGeometryFields(
            @RequestParam String ontologyIdentification) throws IOException {
    ...
    public ResponseEntity<Map<String, String>> getOntologyFields(
            @RequestParam String ontologyIdentification) throws IOException {
    ...
    public ResponseEntity<Map<String, String>> createLayer(org.springframework.ui.Model model, @Valid LayerDTO layerDto,
        ...
        if (layerDto.getOntology() != null) {
            ...
            if (ontology != null) {
                ...
                layerService.create(
                        this.buildLayerForOntologyLayer(layerDto, httpServletRequest, ontology, user, new Layer(),
                                                        false));
    ...
    public @ResponseBody
    Boolean isLayerInUse(@PathVariable(LAYER) String layer) {
    ...
    public @ResponseBody
    String insert(String ontologyID, String body) {
    ...
    public @ResponseBody
    String update(String ontologyID, String body, String oid) {
    ...
    public @ResponseBody
    String deleteById(String ontologyID, String oid) {
    ...
    public String processQuery(String query, String ontologyID, String method, String body, String objectId) {
        ...
        final OperationModel model = OperationModel.builder(ontologyID, OperationType.valueOf(operationType.name()),
                                                            user.getUserId(),
                                                            OperationModel.Source.INTERNAL_ROUTER).body(body).queryType(
                QueryType.SQL).objectId(objectId).deviceTemplate("").build();
