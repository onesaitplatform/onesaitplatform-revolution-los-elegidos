...
public class CacheRestController {
    ...
    public ResponseEntity<String> create(
            @ApiParam(value = "Identification for the cache structure", required = true) @PathVariable(
    ...
    public ResponseEntity<String> deleteMap(
            @ApiParam(value = "Identification for the map", required = true) @PathVariable("identification") String identification) {
    ...
    public ResponseEntity<String> putIntoMap(
            @ApiParam(value = "Identification of the map where put data", required = true) @PathVariable(
                    "identification") String identification,
            @ApiParam(value = "Key to store the data", required = true) @PathVariable("key") String key,
    ...
    public ResponseEntity<String> getFromMap(
            @ApiParam(value = "Identification of the map to get data", required = true) @PathVariable("identification"
