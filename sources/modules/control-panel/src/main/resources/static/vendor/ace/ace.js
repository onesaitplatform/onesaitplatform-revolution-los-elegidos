(function () {
    ...
    Array.prototype.forEach || (Array.prototype.forEach = function (t) {
        var n = q(this), r = g && a(this) == "[object String]" ? this.split("") : n, i = arguments[1], s = -1,
            o = r.length >>> 0;
        if (a(t) != "[object Function]") throw new TypeError;
        while (++s < o) s in r && t.call(i, r[s], s, n)
    }), Array.prototype.map || (Array.prototype.map = function (t) {
        var n = q(this), r = g && a(this) == "[object String]" ? this.split("") : n, i = r.length >>> 0, s = Array(i),
            o = arguments[1];
        if (a(t) != "[object Function]") throw new TypeError(t + " is not a function");
        for (var u = 0; u < i; u++) u in r && (s[u] = t.call(o, r[u], u, n));
        return s
    }), Array.prototype.filter || (Array.prototype.filter = function (t) {
        var n = q(this), r = g && a(this) == "[object String]" ? this.split("") : n, i = r.length >>> 0, s = [], o,
            u = arguments[1];
        if (a(t) != "[object Function]") throw new TypeError(t + " is not a function");
    ...
    e("./lib/fixoldbrowsers");
    var r = e("./lib/oop"), i = e("./lib/lang"), s = e("./lib/useragent"), o = e("./keyboard/textinput").TextInput,
        u = e("./mouse/mouse_handler").MouseHandler, a = e("./mouse/fold_handler").FoldHandler,
        f = e("./keyboard/keybinding").KeyBinding, l = e("./edit_session").EditSession, c = e("./search").Search,
        h = e("./range").Range, p = e("./lib/event_emitter").EventEmitter,
        d = e("./commands/command_manager").CommandManager, v = e("./commands/default_commands").commands,
        m = e("./config"), g = function (e, t) {
        ...
        r.implement(this, p), this.setKeyboardHandler = function (e) {
            ...
            if (!(t.start.row < t.end.row || t.start.column < t.end.column)) {
                ...
                if (this.session.getUseSoftTabs()) {
                    var s = e.getTabSize(), o = this.getCursorPosition(), u = e.documentToScreenColumn(o.row, o.column),
                        a = s - u % s;
                    r = i.stringRepeat(" ", a)
                } else r = "	";
            ...
            var t = this.selection.getCursor().row, n = this.selection.getCursor().column, r = new h(t, n - 1, t, n),
    ...
    var r = e("../lib/event"), i = e("../lib/useragent"), s = e("./default_handlers").DefaultHandlers,
        ...
        a = e("./dragdrop").DragdropHandler, f = function (e) {
    ...
    var r = e("./config"), i = e("./lib/oop"), s = e("./lib/lang"), o = e("./lib/net"),
    ...
    (function () {
        ...
        i.implement(this, u), this.setDocument = function (e) {
            ...
            var o = r + e.end.row - e.start.row, u = e.isMultiLine() ? e.end.column : i + e.end.column - e.start.column,
                a = new l(r, i, o, u);
    ...
    var r = e("../tokenizer").Tokenizer, i = e("./text_highlight_rules").TextHighlightRules,
        s = e("./behaviour").Behaviour, o = e("../unicode"), u = function () {
    ...
    function u() {
        this.getFoldAt = function (e, t, n) {
            ...
            t = t.domEvent;
            var n = this.getFoldWidget(e), r = this.getLine(e), i = t.shiftKey,
                s = i || t.ctrlKey || t.altKey || t.metaKey, o;
    ...
    (function () {
        this.showGutter = !0, this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, v), this.updateCharacterSize = function () {
            ...
            var e = this.session, t = this.scrollTop % this.lineHeight, n = this.$size.scrollerHeight + this.lineHeight,
                r = this.$getLongestLine(), i = this.$horizScrollAlwaysVisible || this.$size.scrollerWidth - r < 0,
    ...
    (function () {
        i.implement(this, o), this.setSession = function (e) {
            ...
            var t = {className: ""}, n = [], i = e.firstRow, s = e.lastRow, o = this.session.getNextFoldLine(i),
                ...
                f = this.session.$breakpoints, l = this.session.$decorations, c = 0;
            for (; ;) {
    ...
    (function () {
        this.$padding = 0, this.setPadding = function (e) {
            ...
            var s = r.lineHeight, o = (t.end.column + (i || 0) - t.start.column) * r.characterWidth,
                u = this.$getTop(t.start.row, r), a = this.$padding + t.start.column * r.characterWidth;
