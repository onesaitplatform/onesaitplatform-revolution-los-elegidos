...
function typeOf(t) {
    return null === t || void 0 === t ? String(t) : class2type[Object.prototype.toString.call(t)] || "object"
}

function isEmpty(t) {
    var e, r;
    if ("object" === typeOf(t)) for (e in t) if (r = t[e], void 0 !== r && "function" !== typeOf(r)) return !1;
    return !0
}
...
function stringify(t) {
    ...
    return e = {
        undefined: function () {
            ...
            var n = "";
            return 0 === t.length ? n += "[]" : (r = r.replace(/$/, " "), t.forEach(function (t) {
                var o = e[typeOf(t)];
                if (!o) throw new Error("what the crap: " + typeOf(t));
                n += "\n" + r + "- " + o(t)
            }), r = r.replace(/ /, ""), n)
        }, object: function (t) {
            var n = "";
            return 0 === Object.keys(t).length ? n += "{}" : (r = r.replace(/$/, " "), Object.keys(t).forEach(function (o) {
                var i = t[o], a = e[typeOf(i)];
                if ("undefined" != typeof i) {
                    if (!a) throw new Error("what the crap: " + typeOf(i));
                    n += "\n" + r + o + ": " + a(i)
                }
            }), r = r.replace(/ /, ""), n)
        }, function: function () {
...
var global = Function("return this")(), classes = "Boolean Number String Function Array Date RegExp Object".split(" "),
    i, name, class2type = {};
for (i in classes) classes.hasOwnProperty(i) && (name = classes[i], class2type["[object " + name + "]"] = name.toLowerCase());
String.prototype.entityify || (String.prototype.entityify = function () {
    ...
    var t, e, r = this.length, n = '"';
    for (e = 0; e < r; e += 1) if (t = this.charAt(e), t >= " ") "\\" !== t && '"' !== t || (n += "\\"), n += t; else switch (t) {
        case"\b":
            n += "\\b";
            break;
        case"\f":
        ...
        case"\t":
            ...
            break;
        default:
            t = t.charCodeAt(), n += "\\u00" + Math.floor(t / 16).toString(16) + (t % 16).toString(16)
    }
    return n + '"'
...
}), global.typeOf = global.typeOf || typeOf, global.isEmpty = global.isEmpty || isEmpty;