...
var setActiveTree = function (id) {
    ...
    $.ajax({
        url: "/controlpanel/categorization/setActive",
        data: {"id": id},
        type: "POST",
        headers: {
    ...
    $.confirm({
        ...
        buttons: {
            ...
            Ok: {
                ...
                action: function () {
                    $.ajax({
                        url: "/controlpanel/categorization/delete",
                        data: {"id": id},
                        type: "POST",
                        headers: {
                            [csrf_header]: csrf_value
...
var deactivateTree = function (id) {
    ...
    $.ajax({
        url: "/controlpanel/categorization/deactivate",
        data: {"id": id},
        type: "POST",
        headers: {
            [csrf_header]: csrf_value
...
var publicTree = function (id) {
    ...
    $.ajax({
        url: "/controlpanel/categorization/setPublic",
...
var create = function () {
    if ($("#identification").val()) {
        ...
        $.ajax({
            url: "/controlpanel/categorization/create",
            type: "POST",
            data: {
                "name": $("#identification").val(),
                "json": JSON.stringify($("#treeField").jstree(true).get_json('#', {flat: true}))
            },
            headers: {
                [csrf_header]: csrf_value
            }
...
var edit = function (id) {
    $("#treeField").jstree("deselect_all");
    $.ajax({
        url: "/controlpanel/categorization/edit",
        type: "POST",
...
var getElements = function (type) {
    ...
    switch (type) {
        ...
        case "flows":
            $.ajax({
                url: "/controlpanel/categorization/getFlows",
                type: "GET",
                dataType: "text",
                headers: {
                    [csrf_header]: csrf_value
