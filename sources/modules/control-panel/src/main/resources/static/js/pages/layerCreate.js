            ...
            submitHandler: function (form) {
                ...
                if (geometryField == null || geometryField == undefined || geometryField == "select") {
                    $.alert({
                        ...
                        theme: 'light',
                        type: 'red',
                        content: layerCreateJson.validations.geometry
                    });
                    return;
                }
                ...
                success: function (response, status) {
                    if (response == true) {
                        ...
                        $.alert({
                            ...
                            theme: 'light',
                            type: 'red',
                            content: layerCreateJson.validations.root
                        });
                    }
                }
            });
                ...
                success: function (response, status) {
                    ...
                    if (Object.entries(response).length === 0 && response.constructor === Object) {
                        $.alert({
                            ...
                            theme: 'light',
                            type: 'red',
                            content: layerCreateJson.validations.ontology
                        });
                        return;
                    }
                    $("#fields").empty();
        ...
        checkAttribute: function (attribute, field) {
            ...
            if (attributesArray.length !== areUniqueAttribute.length) {
                ...
                $.alert({
                    ...
                    theme: 'light',
                    type: 'red',
                    content: layerCreateJson.validations.duplicates
                });
