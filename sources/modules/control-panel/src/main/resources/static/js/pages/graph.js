var GraphController = function () {
    ...
    var links = [], nodes = [], data = [], edges = [], ArraySource = [], jsonProjects = {}, options = {},
        jsonIndex = {}, graphData = {
            nodes: [],
            edges: []
    ...
    var createRelationsInfoTable = function () {
        ...
        // i18 labels
        var propertyCol = graphReg.propertyCol, valueCol = graphReg.valueCol, tableName = graphReg.tableName,
            tableSource = graphReg.tableSource, tableLinkS = graphReg.tableLinkS, tableLinkC = graphReg.tableLinkC,
