var GadgetsTemplateCreateController = function () {
    ...
    var deleteGadgetTemplateConfirmation = function (gadgetTemplateId) {
        ...
        // no Id no fun!
        if (!gadgetTemplateId) {
            $.alert({title: 'ERROR!', type: 'red', theme: 'dark', content: 'NO GATGET TEMPLATE SELECTED!'});
            return false;
        }
    ...
    var handleVS = function () {
        ...
        htmlelement.ondragover = function (e) {
            allowDrop(e)
        };
        htmlelement.ondrop = function (e) {
            dropParam(e, myVSHTML)
        };
    ...
    var updatePreview = function (paramMap) {
        ...
        iframe.onload = function () {
            ...
            templateCodeHTML.isFirstChange = function () {
                return false
            }
            if (paramMap) {
            ...
            templateCodeJS.isFirstChange = function () {
                return false
            }
