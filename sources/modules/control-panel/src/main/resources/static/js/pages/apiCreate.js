...
var ApiCreateController = function () {
    ...
    function deleteAPIConfirmation() {
        ...
        // no Id no fun!
        if (!id) {
            $.alert({title: 'ERROR!', type: 'red', theme: 'light', content: 'NO USER-FORM SELECTED!'});
            return false;
        }
...
//            	apiSwagger.val(endpoint + "/services/management/api-docs?url=/services/management/swagger" + "/v" + apiVersion + "/" + apiName + "/swagger.json");
    ...
    function formatData() {
        ...
        if ((ontology != null) && (ontology.length != 0)) {
            ...
            if ($('#GETAll').attr('class') == 'op_button_selected') {
                ...
                var operationGETAll = {
                    identification: nameApi + "_GETAll",
                    description: $('#description_GETAll').val(),
                    operation: "GET",
                    path: $('#description_GETAll_label').text(),
                    querystrings: querystringsGETAll
                };
            ...
            if ($('#GET').attr('class') == 'op_button_selected') {
                ...
                var operationGET = {
                    identification: nameApi + "_GET",
                    description: $('#description_GET').val(),
                    operation: "GET",
                    path: $('#description_GET_label').text(),
                    querystrings: querystringsGET
                };
                querystringparameter = {name: "id", dataType: "STRING", headerType: "PATH", description: ""};
                operationGET.querystrings.push(querystringparameter);
            ...
            if ($('#POST').attr('class') == 'op_button_selected') {
                ...
                var operationPOST = {
                    identification: nameApi + "_POST",
                    description: $('#description_POST').val(),
                    operation: "POST",
                    path: $('#description_POST_label').text(),
                    querystrings: querystringsPOST
                };
            ...
            if ($('#PUT').attr('class') == 'op_button_selected') {
                ...
                var operationPUT = {
                    identification: nameApi + "_PUT",
                    description: $('#description_PUT').val(),
                    operation: "PUT",
                    path: $('#description_PUT_label').text(),
                    querystrings: querystringsPUT
                };
                querystringparameter = {
                    name: "body",
                    dataType: "STRING",
            ...
            if ($('#DELETEID').attr('class') == 'op_button_selected') {
                ...
                var operationDELETEID = {
                    identification: nameApi + "_DELETEID",
                    description: $('#description_DELETEID').val(),
                    operation: "DELETE",
                    path: $('#description_DELETEID_label').text(),
                    querystrings: querystringsDELETEID
                };
                querystringparameter = {name: "id", dataType: "STRING", headerType: "PATH", description: ""};
    ...
    function initAuthorization(authorizationArray) {
        ...
        for (var i = 0; i < authorizationArray.length; i += 1) {
            ...
            var propAuth = {
                "users": authElement.userId,
                "usersFullName": authElement.userFullName,
                "id": authElement.id
            };
