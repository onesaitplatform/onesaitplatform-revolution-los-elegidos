...
let startLongitude = -15.434
let startLatitude = 28.134
let startHeight = 4500
...
let baseMapsLayers = viewer.imageryLayers
let baseMap = null
let heatMapLayers = []
...
function getLayerData(layer, queryParams) {
    var url = "http://localhost:18000/controlpanel/layer/getLayerData?layer=" + layer;
