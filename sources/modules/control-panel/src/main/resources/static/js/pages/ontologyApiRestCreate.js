...
var OntologyCreateController = function () {
    ...
    $('#addOperation').on('click', function () {
        ...
        if (name == "" || name == null || name == undefined) {
            $.alert({
                ...
                type: 'red',
                theme: 'light',
                content: ontologyCreateReg.validations.operation.name
            });
            return;
        }
        ...
        if (description == "" || description == null || description == undefined) {
            $.alert({
                ...
                type: 'red',
                theme: 'light',
                content: ontologyCreateReg.validations.operation.desc
            });
            return;
        }

        //check Unique names for operations
        if (operationsNames.includes(name)) {
        ...
        var indexes = $("input[name='indexes\\[\\]']").map(function () {
            if ($(this).val() !== '') {
                return $(this).val();
            }
        }).get();
        var namesPath = $("input[name='namesPaths\\[\\]']").map(function () {
            if ($(this).val() !== '') {
                return $(this).val();
            }
        }).get();
        var fieldsPath = $("input[name='fieldsPaths\\[\\]']").map(function () {
            if ($(this).val() !== '') {
                return $(this).val();
            }
        }).get();
        ...
        if (namesPath.length) {
            $.each(namesPath, function (index, value) {
                ...
                pathParamJson.push({
                    'indexes': indexes[nameIndex],
                    'namesPaths': value,
                    'fieldsPaths': fieldsPath[index]
                });
        ...
        if (notInPathDefinition.length > 0) {
            $.alert({
                ...
                theme: 'light',
                type: 'red',
                content: ontologyCreateReg.validations.wrong.path.params + ' ' + notInPathDefinition.toString().replace(/,/g, ', ')
            });
            return false;
        }
        var namesQuery = $("input[name='namesQueries\\[\\]']").map(function () {
            if ($(this).val() !== '') {
                return $(this).val();
            }
        }).get();
        var fieldsQuery = $("input[name='fieldsQueries\\[\\]']").map(function () {
            if ($(this).val() !== '') {
                return $(this).val();
            }
        }).get();
        ...
        if ((defaultOperationType == 'GET_BY_ID' || defaultOperationType == 'DELETE_BY_ID' || defaultOperationType == 'UPDATE_BY_ID') && numParams != 1) {
            ...
            $.alert({
                ...
                theme: 'light',
                type: 'red',
                content: ontologyCreateReg.validations.operation.one.param
            });
            return false;
        }
        if ((defaultOperationType == 'GET_ALL' || defaultOperationType == 'INSERT' || defaultOperationType == 'DELETE_ALL') && numParams != 0) {
            ...
            $.alert({
                ...
                theme: 'light',
                type: 'red',
                content: ontologyCreateReg.validations.operation.no.params
            });
            return false;
        }
    ...
    $('#importSwagger').on('click', function () {
        ...
        $.get(url, function (data, status) {
            ...
            $.alert({
                ...
                type: 'red',
                theme: 'light',
                content: ontologyCreateJson.validations.apirest.invalidUrl
            });
        });
            ...
            if (data.basePath && data.host && data.paths) {
                ...
                if (duplicatedOperations.length > 0) {
                    ...
                    $.alert({
                        ...
                        type: 'red',
                        theme: 'light',
                        content: ontologyCreateJson.validations.apirest.duplicates + ' ' + duplicatedOperations.toString().replace(/,/g, ', ')
                    });
                }
                ...
                $.alert({
                    ...
                    type: 'red',
                    theme: 'light',
                    content: ontologyCreateJson.validations.apirest.parseError
                });
            }
        } else {
            $.alert({
            ...
            submitHandler: function (form) {
                ...
                $.each(operations, function (i, item) {
                    ...
                    if (i != 0) {
                        ...
                        json.push({
                            'name': ops[0].innerHTML,
                            'path': ops[1].innerHTML,
                            'type': ops[3].innerHTML,
                            'defaultOperationType': ops[4].innerHTML,
                            'description': ops[5].innerHTML,
                            'origin': ops[6].innerHTML,
                            'pathParams': JSON.parse(ops[7].innerHTML),
                            'queryParams': JSON.parse(ops[8].innerHTML)
                        });
                ...
                if (postOperations.length > 0 && editorRest.getText() == "{}") {
                    $.alert({
                        ...
                        type: 'red',
                        theme: 'light',
                        content: ontologyCreateReg.validations.schema
                    });
                    return;
                } else {
        ...
        $(".nav-tabs a[href='#tab_2']").on("click", function (e) {
            if ($(this).hasClass("disabled")) {
                ...
                $.alert({
                    ...
                    type: 'blue',
                    theme: 'light',
                    content: ontologyCreateReg.validations.authinsert
                });
                return false;
            }
        });
                ...
                for (var i = 0; i < operations.length; i++) {
                    ...
                    for (var x = 0; x < params.length; x++) {
                        ...
                        if (param.type == 'PATH') {
                            jsonPath.push({
                                'indexes': param.index,
                                'namesPaths': param.name,
                                'fieldsPaths': param.field
                            });
    ...
    var deleteOntologyConfirmation = function (ontologyId) {
        ...
        // no Id no fun!
        if (!ontologyId) {
            $.alert({title: 'ERROR!', type: 'red', theme: 'light', content: ontologyCreateReg.validations.validform});
            return false;
        }
        ...
        if (IsJsonString(editor.getText())) {
            ...
            if ((ontologia.properties == undefined && ontologia.required == undefined)) {
                ...
                $.alert({
                    ...
                    type: 'red',
                    theme: 'light',
                    content: ontologyCreateReg.validations.schemaprop
                });
                isValid = false;
                return isValid;
            ...
            $.alert({
                ...
                type: 'red',
                theme: 'light',
                content: ontologyCreateReg.validations.noschema
            });
            return isValid;
    ...
    return {
            ...
            if (ontologyCreateReg.actionMode !== null) {
                ...
                if (($('#users').val() !== '') && ($("#users option:selected").attr('disabled') !== 'disabled') && ($('#accesstypes').val() !== '')) {
                    ...
                    $.alert({
                        ...
                        theme: 'light',
                        type: 'red',
                        content: ontologyCreateReg.validations.authuser
                    });
                }
            }
        },
        ...
        checkNamePaths: function (obj) {
            ...
            var allProperties = $("input[name='namesPaths\\[\\]']").map(function () {
                return $(this).val();
            }).get();
        ...
        checkNameQueries: function (obj) {
            ...
            var allProperties = $("input[name='namesQueries\\[\\]']").map(function () {
                return $(this).val();
            }).get();
            areUnique = allProperties.unique();
            if (allProperties.length !== areUnique.length) {
        ...
        updateOperation: function () {
            ...
            var fieldsPath = $("input[name='namesPaths\\[\\]']").map(function () {
                if ($(this).val() !== '') {
                    return $(this).val();
                }
            }).get();
            ...
            if (namesPath.length) {
                $.each(namesPath, function (index, value) {
                    ...
                    jsonPathParams.push({
                        'indexes': indexes[nameIndex],
                        'namesPaths': value,
                        'fieldsPaths': fieldsPath[nameIndex]
                    });
                    if (!path.includes('{' + value + '}')) notInPathDefinition.push(value);
                });
            }
