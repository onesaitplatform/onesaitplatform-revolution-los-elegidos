var HeaderController = function () {
    ...
    var searchDocs = function () {
        ...
        // NOT-AVAILABLE 
        $.alert({title: 'onesait Platform Search:', theme: 'light', content: 'FUNCTIONALITY NOT-AVAILABLE!'});
        return false;
        ...
        $.ajax(settings).done(function (response) {
            ...
            blogResults = response.filter(function (f) {
                return f.type == "blog";
            });
            docsResults = response.filter(function (f) {
                return f.type == "doc";
            });
            ...
            if (blogResults.length > 0) {
                ...
                for (var i = 0; i < blogResults.length; i++) {
                    ...
                    if (doc.imageUrl) {
                        html += "<img style='width: 100%;;' src=" + doc.imageUrl + "></img>"
                    }
                    ;
    ...
    var errors = function () {
        ...
        if (headerReg.errores !== null) {
            ...
            logControl ? console.log('|---> errors() -> NO ERRORS FROM SERVER.') : '';
        }
    }
...
//		}
            ...
            logControl ? console.log('|---> information() -> NO ERROR INFO.') : '';
        }
    }
