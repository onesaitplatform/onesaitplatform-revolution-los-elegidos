var ApiCustomOpsController = function () {
    ...
    function getRtdbFromOntology() {
        ...
        $.ajax({
            url: "/controlpanel/querytool/rtdb/" + $("#ontology option:selected").text(),
            headers: {
    ...
    function loadParamQuery(param) {
        ...
        var parameter = {
            name: param,
            condition: "REQUIRED",
            dataType: $('[name="customsqlParamType_' + param + "\"").val(),
            description: ""
        };
            ...
            if (errorQuery != null && errorQuery == "") {
                if (name_op_edit_customsql == null || name_op_edit_customsql == "") {
                    if (!ApiCreateController.existOperation(id_name_op_customsql)) {
                        ...
                        var operation = {
                            identification: id_name_op_customsql,
                            description: desc_op_customsql,
                            operation: id_type_op_customsql,
                            path: "",
    ...
    function saveParamQueryCustomsql(operation) {
        var queryParameter = {
            ...
            condition: "CONSTANT",
            dataType: "STRING",
            value: $('#id_query_op_customsql').val(),
            description: "",
            headerType: "QUERY"
        };
        operation.querystrings.push(queryParameter);
        var targetBDParameter = {
            name: "targetdb",
            condition: "CONSTANT",
            dataType: "STRING",
            value: $('#id_customsql_targetBD').val(),
            description: "",
            headerType: "QUERY"
        };
        operation.querystrings.push(targetBDParameter);
        var querytypeBDParameter = {
            name: "queryType",
            condition: "CONSTANT",
            dataType: "STRING",
            value: $('#id_customsql_querytype').val(),
            description: "",
            headerType: "QUERY"
        };
