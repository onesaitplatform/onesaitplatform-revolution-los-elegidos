var MenuController = function () {
    ...
    var consoleMenu = function () {
        ...
        // NO-DATA NO-FUN!
        if (!menuReg) {
            $.alert({title: 'MENU ERROR!', content: 'No Menu Data!'});
            return false;
        }
    ...
    var setActiveNavItem = function () {
        ...
        if (currentPath === '/controlpanel/main') {
            firstMenu.closest('li.nav-item').addClass('open active');
            return false;
        } else {
            firstMenu.closest('li.nav-item').removeClass('open active');
        }
