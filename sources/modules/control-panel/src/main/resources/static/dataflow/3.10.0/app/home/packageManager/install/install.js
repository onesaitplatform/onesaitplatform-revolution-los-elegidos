...
angular
    ...
    .controller('InstallModalInstanceController',
        ["$scope", "$rootScope", "$modalInstance", "libraryList", "withStageLibVersion", "api", "pipelineConstant", "$modal", function ($scope, $rootScope, $modalInstance, libraryList, withStageLibVersion, api, pipelineConstant, $modal) {
