    ...
    .controller('SnapshotModalInstanceController', function (
        ...
        angular.extend($scope, {
            ...
            deleteSnapshot: function (snapshotName, index) {
                ...
                api.pipelineAgent.deleteSnapshot(pipelineConfig.info.pipelineId, 0, snapshotName).then(function () {
            ...
            snapshotInfoLabelUpdated: function (snapshotInfo) {
                api.pipelineAgent.updateSnapshotLabel(pipelineConfig.info.pipelineId, 0, snapshotInfo.id, snapshotInfo.label).then(function () {
