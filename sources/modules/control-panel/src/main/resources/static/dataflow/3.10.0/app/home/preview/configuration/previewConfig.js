...
angular
    ...
    .controller('PreviewConfigModalInstanceController', ["$scope", "$rootScope", "$modalInstance", "pipelineConfig", "pipelineStatus", "$timeout", "pipelineService", "api", "pipelineConstant", function (
