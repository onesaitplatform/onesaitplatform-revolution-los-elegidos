                    ...
                    try {
                        ...
                        if (jsonConfigObj.uuid) {
                            if (pipelineInfo && !$scope.createNewPipeline) { // If pipeline config already exists
                                ...
                                api.pipelineAgent.savePipelineConfig(pipelineInfo.pipelineId, jsonConfigObj).then(function (res) {
                                    if (jsonRulesObj && jsonRulesObj.uuid) {
                                        api.pipelineAgent.getPipelineRules(pipelineInfo.pipelineId).then(function (res) {
                                            ...
                                            api.pipelineAgent.savePipelineRules(pipelineInfo.pipelineId, rulesObj).then(function () {
                                                $modalInstance.close();
                                            });
                                ...
                                api.pipelineAgent.createNewPipelineConfig(label, description)
                                    ...
                                    .then(function (res) {
                                        if (jsonRulesObj && jsonRulesObj.uuid) {
                                            api.pipelineAgent.getPipelineRules(name).then(function (res) {
                                                var rulesObj = res.data;
                                                rulesObj.schemaVersion = jsonRulesObj.schemaVersion;
                                                rulesObj.version = jsonRulesObj.version;
                                                rulesObj.metricsRuleDefinitions = jsonRulesObj.metricsRuleDefinitions;
                                                ...
                                                api.pipelineAgent.savePipelineRules(name, rulesObj).then(function () {
