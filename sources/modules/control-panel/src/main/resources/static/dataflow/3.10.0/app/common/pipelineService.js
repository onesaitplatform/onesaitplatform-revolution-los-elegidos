...
angular.module('dataCollectorApp.common')
    .service('pipelineService', ["pipelineConstant", "api", "$q", "$translate", "$modal", "$location", "$route", "_", "$window", function (pipelineConstant, api, $q, $translate, $modal, $location, $route, _, $window) {
