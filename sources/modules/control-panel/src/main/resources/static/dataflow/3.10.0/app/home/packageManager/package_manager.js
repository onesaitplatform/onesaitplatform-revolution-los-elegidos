...
angular
    ...
    .controller('PackageManagerController', ["$scope", "$rootScope", "$routeParams", "$q", "$modal", "$location", "pipelineService", "api", "configuration", "pipelineConstant", "Analytics", function (
