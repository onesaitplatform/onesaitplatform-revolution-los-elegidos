...
angular
    ...
    .controller('BadRecordsController', ["$scope", "$rootScope", "_", "api", "pipelineConstant", "$filter", "$timeout", "$modal", function ($scope, $rootScope, _, api, pipelineConstant, $filter, $timeout, $modal) {
