                ...
                link: function (scope, element, attrs) {
                    ...
                    scope.$watch('data', function (newData, oldData) {
                        if (newData !== oldData && scope.chart) {
                            if (!scope._config.disabled && scope._config.autorefresh) {
                                if (scope._config.refreshDataOnly && scope.chart.update) {
                                    scope.chart.update();
                                } else {
                                    scope.api.refresh(); // if wanted to refresh data only, use chart.update method, otherwise use full refresh.
                                }
                            }
                        }
