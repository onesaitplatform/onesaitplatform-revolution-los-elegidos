...
(function (d, h, l, g, m, b, j) {
    ...
    var p = {
        ...
        button: {x: -4, y: -3, wx: -2, src: l.fileURL(b.imageDir + "/MenuArrow-15.png")},
        fadeinInc: 0.2,
        fadeoutInc: 0.05,
        fadeDelay: 50,
        fadeoutStart: 400,
    ...
    var f = c.Hover = {
        Mouseover: function (t, s) {
            ...
            var u = b[r.outputJax], w = u.getHoverSpan(r, v), z = u.getHoverBBox(r, w, v),
...
(function (a, d, f, c, j) {
    ...
    var h = MathJax.Extension.MathZoom = {
        version: k, settings: a.config.menuSettings, scrollSize: 18, HandleEvent: function (n, l, m) {
            ...
            var m = d.Element("span", {id: "MathJax_ZoomFrame"}, [["span", {
            ...
            if (this.msieTrapEventBug) {
                var w = d.Element("span", {id: "MathJax_ZoomEventTrap", onmousedown: this.Remove});
                m.insertBefore(w, x)
            }
...
(function (c, g, k, f, b) {
    ...
    var a = MathJax.Menu = MathJax.Object.Subclass({
        version: q, items: [], posted: false, title: null, margin: 5, Init: function (r) {
    ...
    a.ITEM.SUBMENU = a.ITEM.Subclass({
        menu: null, marker: (n && !c.Browser.isSafari ? "\u25B6" : "\u25B8"), Init: function (r, t) {
            if (!(r instanceof Array)) {
                r = [r, r]
            }
            this.name = r;
    ...
    a.ITEM.RADIO = a.ITEM.Subclass({
        variable: null, marker: (n ? "\u25CF" : "\u2713"), Init: function (s, r, t) {
            ...
            var r = {className: "MathJax_MenuRadioCheck"};
    ...
    a.ITEM.CHECKBOX = a.ITEM.Subclass({
        variable: null, marker: "\u2713", Init: function (s, r, t) {
            ...
            var r = {className: "MathJax_MenuCheck"};
    ...
    c.Register.StartupHook("End Config", function () {
        ...
        a.menu = a(m.SUBMENU(["Show", "Show Math As"], m.COMMAND(["MathMLcode", "MathML Code"], a.ShowSource, {
            nativeTouch: true,
            format: "MathML"
        }), m.COMMAND(["Original", "Original Form"], a.ShowSource, {nativeTouch: true}), m.SUBMENU(["Annotation", "Annotation"], {disabled: true}), m.RULE(), m.CHECKBOX(["texHints", "Show TeX hints in MathML"], "texHints")), m.RULE(), m.SUBMENU(["Settings", "Math Settings"], m.SUBMENU(["ZoomTrigger", "Zoom Trigger"], m.RADIO(["Hover", "Hover"], "zoom", {action: a.Zoom}), m.RADIO(["Click", "Click"], "zoom", {action: a.Zoom}), m.RADIO(["DoubleClick", "Double-Click"], "zoom", {action: a.Zoom}), m.RADIO(["NoZoom", "No Zoom"], "zoom", {value: "None"}), m.RULE(), m.LABEL(["TriggerRequires", "Trigger Requires:"]), m.CHECKBOX((c.Browser.isMac ? ["Option", "Option"] : ["Alt", "Alt"]), "ALT"), m.CHECKBOX(["Command", "Command"], "CMD", {hidden: !c.Browser.isMac}), m.CHECKBOX(["Control", "Control"], "CTRL", {hidden: c.Browser.isMac}), m.CHECKBOX(["Shift", "Shift"], "Shift")), m.SUBMENU(["ZoomFactor", "Zoom Factor"], m.RADIO("125%", "zscale"), m.RADIO("133%", "zscale"), m.RADIO("150%", "zscale"), m.RADIO("175%", "zscale"), m.RADIO("200%", "zscale"), m.RADIO("250%", "zscale"), m.RADIO("300%", "zscale"), m.RADIO("400%", "zscale")), m.RULE(), m.SUBMENU(["Renderer", "Math Renderer"], {hidden: !p.showRenderer}, m.RADIO("HTML-CSS", "renderer", {action: a.Renderer}), m.RADIO("MathML", "renderer", {
            action: a.Renderer,
            value: "NativeMML"
        }), m.RADIO("SVG", "renderer", {action: a.Renderer})), m.SUBMENU("MathPlayer", {
            ...
            name: ["", "discover_rule"]
        }), m.CHECKBOX(["Discoverable", "Highlight on Hover"], "discoverable", {hidden: !p.showDiscoverable})), m.SUBMENU(["Locale", "Language"], {hidden: !p.showLocale}, m.RADIO("en", "locale", {action: a.Locale}), m.RULE().With({
...
(function (a) {
    ...
    a.mfenced = a.mbase.Subclass({
        ...
        setTeXclass: function (g) {
            ...
            if (e.open !== "") {
                this.SetData("open", a.mo(e.open).With({stretchy: true, texClass: a.TEXCLASS.OPEN}));
            ...
            if (e.close !== "") {
                this.SetData("close", a.mo(e.close).With({stretchy: true, texClass: a.TEXCLASS.CLOSE}));
    ...
    a.mmultiscripts = a.msubsup.Subclass({
        type: "mmultiscripts", adjustChild_texprimestyle: function (d) {
            if (d % 2 === 1) {
                return true
            }
            return this.Get("texprimestyle")
...
(function (d, c, i) {
    ...
    var a = MathJax.Object.Subclass({
        ...
        Superscript: function (p) {
            ...
            if (m.type === "msubsup") {
                ...
                if (m.movesupsub) {
                    if (m.type !== "munderover" || m.data[m.over]) {
                        ...
                        m = h.munderover(m, null, null).With({movesupsub: true})
                    }
                    l = m.over
                } else {
            ...
            this.Push(b.subsup(m).With({position: l, primes: o}))
        },
        ...
        UnderOver: function (n, q, l) {
            ...
            m.data[m[p]] = this.mmlToken(h.mo(h.entity("#x" + q)).With({stretchy: true, accent: (p == "under")}));
            this.Push(m)
        },
        Overset: function (l) {
        ...
        MmlToken: function (n) {
            var o = this.GetArgument(n), l = this.GetBrackets(n, "").replace(/^\s+/, ""), r = this.GetArgument(n),
                q = {attrNames: []}, m;
        ...
        BuildRel: function (l) {
            ...
            this.Push(h.TeXAtom(h.munderover(n, null, m)).With({mclass: h.TEXCLASS.REL}))
        },
        HBox: function (l, m) {
        ...
        Matrix: function (m, o, t, q, s, n, l, u) {
            ...
            var p = b.array().With({
                requireClose: true,
                arraydef: {rowspacing: (n || "4pt"), columnspacing: (s || "1em")}
            });
            if (u) {
                p.isCases = true
            }
        ...
        CrLaTeX: function (l) {
            ...
            if (o.isa(b.array)) {
                ...
                this.Push(h.mo().With({linebreak: h.LINEBREAK.NEWLINE}))
            }
        },
        emPerInch: 7.2,
        dimen2em: function (p) {
        ...
        Begin: function (m) {
            ...
            var l = b.begin().With({name: n, end: o[1], parse: this});
            if (o[0] && this[o[0]]) {
        ...
        End: function (l) {
            this.Push(b.end().With({name: this.GetArgument(l)}))
        },
...
MathJax.Extension["TeX/AMSmath"] = {version: "2.3", number: 0, startNumber: 0, labels: {}, eqlabels: {}, refs: []};
MathJax.Hub.Register.StartupHook("TeX Jax Ready", function () {
        ...
        oldCheckItem: e.start.prototype.checkItem, checkItem: function (j) {
            if (j.type === "stop") {
                ...
                if (i.tag) {
                    ...
                    var k = {side: g.config.TagSide, minlabelspacing: g.config.TagIndent, columnalign: h.displayAlign};
...
MathJax.Extension["TeX/AMSsymbols"] = {version: "2.3"};
MathJax.Hub.Register.StartupHook("TeX Jax Ready", function () {
...
(function (c, d) {
    ...
    c.Parse = MathJax.Object.Subclass({
        Init: function (e) {
            ...
            if (typeof g !== "string") {
                ...
                h = c.ParseXML(this.preProcessMath.call(this, g));
                if (h == null) {
            ...
            if (f) {
                c.Error(["ParsingError", "Error parsing MathML: %1", f.textContent.replace(/This page.*?errors:|XML Parsing Error: |Below is a rendering of the page.*/g, "")])
            }
            ...
            if (h.firstChild.nodeName.toLowerCase() === "html") {
                ...
                if (e && e.textContent === "XML parsing error" && e.nextSibling) {
                    c.Error(["ParsingError", "Error parsing MathML: %1", String(e.nextSibling.nodeValue).replace(/fatal parsing error: /, "")])
                }
            }
            if (h.firstChild.nodeName.toLowerCase().replace(/^[a-z]+:/, "") !== "math") {
                c.Error(["MathMLRootElement", "MathML must be formed by a <math> element, not %1", "<" + h.firstChild.nodeName + ">"])
            }
            ...
            for (var h = 0, e = j.attributes.length; h < e; h++) {
                ...
                if (k != null) {
                    ...
                    if (g.defaults[f] != null || a.copyAttributes[f]) {
                        g[f] = k
                    } else {
                        g.attr[f] = k
                    }
            ...
            for (var k = 0, j = g.childNodes.length; k < j; k++) {
                ...
                if (f.nodeName === "#text") {
                    if (e.isToken && !e.mmlSelfClosing) {
                        var o = f.nodeValue.replace(/&([a-z][a-z0-9]*);/ig, this.replaceEntity);
                        e.Append(a.chars(this.trimSpace(o)))
                    } else {
    ...
    c.Augment({
        ...
        Translate: function (e) {
            ...
            i.math = a(f);
            this.postfilterHooks.Execute(i);
            return i.math
        },
        ...
        parseDIV: function (e) {
            this.div.innerHTML = e.replace(/<([a-z]+)([^>]*)\/>/g, "<$1$2></$1>");
            return this.div
        },
