        ...
        init: function () {
            var _init = _asyncToGenerator(
                ...
                regeneratorRuntime.mark(function _callee(S) {
                    var svgEditor, svgCanvas, addElem, $, importLocale, selElems, started, newPM, strings, markerTypes,
                        showPanel, getLinked, updateText, updateFont, addMarker, setMarker, colorChanged,
                        updateReferences, setArrowFromButton, getTitle, addMarkerButtons, buttons, contextTools;
