...
function processResults(url) {
    ...
    return ['div', [
        ['button', {
            style: 'margin-right: 8px; border: 2px solid black;', dataset: {id, value: svgURL}, $on: {
                async click(e) {
            e.preventDefault();
    ...
    ['fieldset', [
        ...
        ['div', {class: 'control'}, [
            ['label', [
                ...
                ['input', {
                    id: 'query', name: 'query', placeholder: 'cat', $custom: {
                        $set(value) {
                            $('#byids')[0].value = '';
                            this.value = value;
                        }
        ...
        ['div', {class: 'control'}, [
            ['label', [
                ...
                ['input', {
                    id: 'byids', name: 'ids', placeholder: '271380, 265741', $custom: {
                        $set(value) {
                            $('#query')[0].value = '';
                            this.value = value;
                        }
