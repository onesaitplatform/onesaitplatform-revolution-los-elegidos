...
public class DeviceSimulatorServiceTest {
    ...
    public void setUp() throws IOException {
        ...
        ontology = "Ticket";
        user = "developer";
        instance = "{\"Ticket\":{\"Identification\":\"\",\"Status\":\"\",\"Email\":\"\",\"Name\":\"\"," +
                "\"Response_via\":\"\",\"File\":{\"data\":\"\",\"media\":{\"name\":\"\"," +
                "\"storageArea\":\"SERIALIZED\",\"binaryEncoding\":\"Base64\",\"mime\":\"application/pdf\"}}," +
                "\"Coordinates\":{\"coordinates\":{\"latitude\":55.5842,\"longitude\":44.0645},\"type\":\"Point\"}}," +
                "\"contextData\":{\"clientPatform\":\"Ticketing App\",\"clientPatformInstance\":\"Ticketing " +
                "App:Ticket\",\"clientConnection\":\"\",\"clientSession\":\"01dbb0ec-74b8-4567-b103-759cf164d9a6\"," +
                "\"user\":\"developer\",\"timezoneId\":\"Europe/Paris\",\"timestamp\":\"Wed Apr 18 15:01:21 CEST " +
                "2018\",\"timestampMillis\":{\"$numberLong\":\"1524056481126\"}}}";
        initMocks();
    }
