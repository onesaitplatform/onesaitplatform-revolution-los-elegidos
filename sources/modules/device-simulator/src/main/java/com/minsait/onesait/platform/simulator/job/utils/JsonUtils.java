...
public class JsonUtils {
    ...
    public JsonNode generateJson(String ontology, String user) throws IOException {
        ...
        JsonNode ontologySchema = mapper.readTree(
        ...
        final Iterator<String> fields =
                !ontologySchema.path(pathData).isMissingNode() ? ontologySchema.path(pathToProperties).path(
                        PATH_PROPERTIES).fieldNames() : ontologySchema.path(PATH_PROPERTIES).fieldNames();
        ontologySchema =
                !ontologySchema.path(pathData).isMissingNode() ? ontologySchema.path(pathData).path(PATH_PROPERTIES)
