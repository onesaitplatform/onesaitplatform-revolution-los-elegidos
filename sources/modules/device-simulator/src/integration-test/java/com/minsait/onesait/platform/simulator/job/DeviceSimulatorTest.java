...
public class DeviceSimulatorTest {
    ...
    public void setUp() throws Exception {
        ...
        this.json = "{\"clientPlatform\":\"DeviceTemp\",\"clientPlatformInstance\":\"DeviceTemp:TempSimulate\"," +
                "\"token\":\"170c81ecbb3347179acf690efe48f9c3\",\"ontology\":\"Ontology\"," +
                "\"fields\":{\"Temp\":{\"function\":\"RANDOM_NUMBER\",\"from\":\"5\",\"to\":\"35\"," +
                "\"precision\":\"0\"}}}";
        this.jsonSchema = "{\"$schema\":\"http://json-schema.org/draft-04/schema#\",\"title\":\"Ontology\"," +
                "\"type\":\"object\",\"required\":[\"Ontology\"],\"properties\":{\"Ontology\":{\"type\":\"string\"," +
                "\"$ref\":\"#/datos\"}},\"datos\":{\"description\":\"Info EmptyBase\",\"type\":\"object\"," +
                "\"required\":[\"Temp\"],\"properties\":{\"Temp\":{\"type\":\"number\"}}},\"description\":\"Ontology " +
