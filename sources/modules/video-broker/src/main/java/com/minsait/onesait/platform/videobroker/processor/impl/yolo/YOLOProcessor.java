...
public class YOLOProcessor extends FrameProcessor {
    ...
    public void loadNetFiles() {
        ...
        try {
            ...
            setWeightsFile(Paths.get(getClass().getClassLoader().getResource(
                    YoloConfig.getWEIGHTS()).toURI()).toAbsolutePath().toString());
            setConfigFile(Paths.get(getClass().getClassLoader().getResource(
                    YoloConfig.getCONFIG()).toURI()).toAbsolutePath().toString());
            setNamesFile(Paths.get(
                    getClass().getClassLoader().getResource(YoloConfig.getNAME()).toURI()).toAbsolutePath().toString());
