...
public class LicensePlateRecognition extends FrameProcessor {
    ...
    public static void main(String[] args) {
        ...
        final String testImagePath = "./src/main/resources/processor/licenseplaterecognition/licenseplateimages" +
                "/matricula_010.jpg";
    ...
    public static void detectPlate(Mat mat) {
        final String pathXMLPlates = "./src/main/resources/processor" +
                ".licenseplaterecognition/haarCascade_license_plate.xml";
    ...
    public static void findLicensePlate() {
        final String templatePlate = "./src/main/resources/processor" +
                ".licenseplaterecognition/licenseplateimages/template.jpg";
        final String testImagePath = "./src/main/resources/processor" +
                ".licenseplaterecognition/licenseplateimages/matricula_001.jpg";
    ...
    public static List<Rect> detectLetters3(Mat img) {
        ...
        final BufferedImage imgGrayscalePlusTopHatMinusBlackHatImage = VideoUtils.matToBufferedImage(
